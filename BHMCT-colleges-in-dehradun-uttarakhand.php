...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/bhmct.webp);">
        <div class="container">
            <h2>Bachelor of Hotel Management & Catering Technology (BHMCT)</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>BHMCT</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Bachelor of Hotel Management & Catering Technology (BHMCT)</h5>
                                <p>The Bachelor of Hotel Management and Catering Technology (BHMCT) is a comprehensive four- year undergraduate degree that focuses on equipping students with the knowledge, skills, and practical experience necessary for successful careers in the hospitality, tourism, and catering sectors. This program combines academic learning with extensive hands-on training to develop competencies in various departments of hotel and hospitality operations, including food production, front office, housekeeping, and food and beverage service.</p> 
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Bachelor in Hotel Management & Catering Technology program offers in-depth knowledge and practical training in hotel operations, catering services, and hospitality management. Graduates are equipped for careers in hotels, restaurants, resorts, and catering industries, ensuring excellence in service and management.</p>
                    </div>
