<?php
$page_title = "BPT Course in Dehradun | Maya Devi University";
$page_description = "Study BPT at Maya Devi University, Dehradun with hands-on physiotherapy training and clinical practice exposure.";
$canonical_url = "https://maya.edu.in/bpt.php";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>BPT</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s BPT (Bachelor of Physiotherapy) program provides comprehensive knowledge and practical training in physiotherapy techniques, rehabilitation, and patient care. Graduates are prepared for careers as physiotherapists, rehabilitation specialists, and clinical assistants, contributing to effective patient recovery and healthcare services in hospitals and clinics.</p>
                    </div>
