<?php
$page_title = "B.Sc. Biotechnology (Hons.) | Maya Devi University Dehradun";
$page_description = "The B.Sc. (Hons.) Biotechnology program is designed to provide advanced knowledge and hands-on skills in molecular biology, genetics, biochemistry, and...";
$canonical_url = "https://maya.edu.in/bsc-biotechnology-hons.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>B.Sc. Biotechnology (Hons.)</h2>
            <p>The B.Sc. (Hons.) Biotechnology program is designed to provide advanced knowledge and hands-on skills in molecular biology, genetics, biochemistry, and industrial biotechnology. It emphasizes laboratory research, bioinformatics, and modern biotechnological applications, preparing graduates for careers in pharmaceuticals, healthcare, agriculture, and global biotech industries, as well as higher studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. Biotechnology (Hons.)</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. Biotechnology (Hons.)</h5>
                                <p>The B.Sc. (Hons.) Biotechnology program at Maya Devi University offers an in-depth and specialized study of biological systems and technological applications. The curriculum covers advanced molecular biology, genetic engineering, biochemistry, microbiology, immunology, bioinformatics, plant and animal biotechnology, environmental biotechnology, and industrial processes.</p>
                                <p>Students receive hands-on laboratory training in DNA isolation, PCR, electrophoresis, gene cloning, microbial techniques, enzyme assays, and bioprocess technology. The honors curriculum includes specialized subjects, seminars, and a mandatory research project that builds scientific thinking, analytical skills, and technical expertise. Graduates are well-prepared for careers in biotechnology companies, pharmaceutical industries, research laboratories, agricultural firms, and healthcare institutions.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to providing high-quality biotechnology education through modern laboratories, advanced research facilities, and qualified faculty. The university emphasizes practical training, innovation, and problem-solving through lab work, industry exposure, and research-based learning. Our mission is to produce research-driven, skilled, and industry-ready biotechnology professionals who contribute to advancements in healthcare, pharmaceuticals, agriculture, and environmental sustainability at national and international levels.</p>
                    </div>
