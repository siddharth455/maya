...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/b-tech-cs.jpeg);">
        <div class="container">
            <h2>B.Tech CSE with Specialization Data Science</h2>
            <p>The Bachelor of Technology (B.Tech) in Computer Science with a Specialization in Data Science is an advanced undergraduate program that combines the core principles of computer science with the analytical techniques of data science.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech Data Science</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Tech CSE with Specialization Data Science</h5>
                                <p>This specialization focuses on key areas such as data analysis, statistics, machine learning, big data technologies, data visualization, and data-driven decision-making.</p>
                                <p>The program is designed to develop both technical expertise and critical thinking skills, enabling students to extract meaningful insights from complex datasets and solve real-world problems across industries. Through hands-on projects, practical labs, and exposure to industry tools, students gain experience in handling and interpreting large-scale data effectively.</p>
<p>Graduates of this program are well-equipped for careers in data science, business analytics, artificial intelligence, and related fields, driving innovation through data-powered solutions.</p>
