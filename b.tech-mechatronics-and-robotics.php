<?php
$page_title = "B.Tech Mechatronics & Robotics in Dehradun | Maya Devi University";
$page_description = "Study B.Tech Mechatronics and Robotics at Maya Devi University, Dehradun with automation labs and hands-on industry training.";
$canonical_url = "https://maya.edu.in/b.tech-mechatronics-and-robotics.php";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech Mechanical (Mechatronics)</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : B.tech Mechanical Engineering (Mechatronics)</h5>
                            <p>Core subjects include mechanics, materials science, dynamics, robotics, and embedded systems. Students learn to design structures embedded with sensors, actuators, and control algorithms. The curriculum emphasizes simulation, modeling, and real-world prototyping of Mechatronics systems. Courses in structural health monitoring and vibration control are key highlights.</p>
                             <p>Hands-on labs and interdisciplinary projects enhance practical engineering skills. The program encourages innovation in aerospace, automotive, civil, and robotics applications. Research and internships with industry partners provide professional exposure. Graduates are prepared for advanced roles in smart systems design and structural innovation.</p>
