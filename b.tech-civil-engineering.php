<?php
$page_title = "B.Tech Civil Engineering in Dehradun | Maya Devi University";
$page_description = "Enroll in B.Tech Civil Engineering at Maya Devi University, Dehradun with practical training, advanced labs, and career-focused education.";
$canonical_url = "https://maya.edu.in/b.tech-civil-engineering.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/civil.webp);">
        <div class="container">
            <h2>B.Tech in Civil Engineering</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech Civil</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/civil.webp" alt="banner">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : B.tech Civil</h5>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidate shall have Passed 12th Examination with Physics, Chemistry, Maths/Biology subjects.These subjects along with theory or theory + practical candidate should have obtained at least 45%.40% marks in the qualifying examination in case of SC/ST category.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="single-course">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-civil-engineering-le.php"><img class="animated" src="assets/uploads/civil-le.webp" alt="Course Image"></a>
                                </div>
                                <div class="course-content">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Tech Civil Engineering program provides technical expertise and practical training in structural, transportation, and environmental engineering. Graduates are prepared for careers in engineering, project management, and research, contributing to infrastructure and sustainable development.</p>
                    </div>
