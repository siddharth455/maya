<?php
$page_title = "B.Sc. Microbiology (Hons.) | Maya Devi University Dehradun";
$page_description = "The B.Sc. (Hons.) Microbiology program is designed to provide advanced knowledge and research skills in studying microorganisms, their functions, and their...";
$canonical_url = "https://maya.edu.in/bsc-microbiology-hons.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>B.Sc. Microbiology (Hons.)</h2>
            <p>The B.Sc. (Hons.) Microbiology program is designed to provide advanced knowledge and research skills in studying microorganisms, their functions, and their applications in healthcare, biotechnology, food, and environmental sciences. It emphasizes laboratory techniques, molecular biology tools, and analytical skills, preparing graduates for careers in research labs, medical diagnostics, pharmaceuticals, and higher studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. Microbiology (Hons.)</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. Microbiology (Hons.)</h5>
                                <p>The B.Sc. (Hons.) in Microbiology program at Maya Devi University provides an in-depth and specialized study of microorganisms including bacteria, viruses, fungi, protozoa, and algae. The curriculum covers advanced subjects such as microbial genetics, immunology, biochemistry, virology, molecular biology, industrial microbiology, medical microbiology, environmental microbiology, and biotechnology.</p>
                                <p>Students receive extensive hands-on training through microbial culturing, staining, microscopic examination, biochemical testing, fermentation technology, and molecular analysis techniques like PCR and electrophoresis. The honors section includes research projects, seminars, and advanced laboratory modules that help students build strong analytical and scientific abilities. Graduates are well-prepared for careers in medical labs, pharmaceutical industries, food industries, biotech companies, and research institutions.</p>
                        ...
                        <div class="related-slider-active">
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="bsc-environmental-science.php"><img class="animated" src="assets/uploads/bsc-pcm-img1.jpg" alt=""></a>
                                </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to excellence in life sciences by offering modern laboratories, expert faculty, and research-focused teaching methods. The university emphasizes hands-on experiments, microbial analysis, and industry exposure to help students gain strong technical and scientific skills. Our mission is to produce competent, research-driven, and industry-ready microbiology graduates who contribute to healthcare, biotechnology, food safety, environmental sustainability, and scientific innovation at both national and global levels.</p>
                    </div>
