<?php
$page_title = "BA Journalism & Mass Communication in Dehradun | Maya Devi University";
$page_description = "Join BA Journalism and Mass Communication at Maya Devi University, Dehradun with practical media training and industry exposure.";
$canonical_url = "https://maya.edu.in/ba-journalism-and-mass-communication.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ba-12.webp);">
        <div class="container">
            <h2>B.A. in Journalism and Mass Communication</h2>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ba-12.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.A. in Journalism and Mass Communication</h5>
                         <p>The course prepares students to become skilled journalists, media professionals, content creators, and communicators. Through newsroom simulations, workshops, seminars, and practical media activities, learners develop strong communication skills, critical thinking, creativity, and overall personality development. Graduates can pursue careers in news agencies, television channels, radio stations, advertising firms, digital media, public relations, NGOs, and corporate communication sectors.</p> <p>The Bachelor of Arts (B.A.) in Journalism and Mass Communication program provides students with a strong foundation in media studies, journalism, reporting, editing, communication theories, advertising, public relations, and digital media production. The curriculum combines theoretical learning with practical training in news writing, video production, photography, media research, and online content creation. Students develop storytelling abilities, technical skills, and media literacy essential for the modern communication industry.</p> <p>Through internships, media projects, field reporting, and interactions with journalists and industry experts, learners gain real-world experience and enhance their practical and professional skills. The program prepares graduates for roles such as reporters, editors, anchors, content writers, videographers, PR executives, social media managers, and communication specialists in media organizations, corporate sectors, and creative industries.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                     ...
                     <p>The Bachelor of Arts (B.A.) in Journalism and Mass Communication program at Maya Devi University provides students with a strong foundation in media studies, journalism, communication theories, and digital content creation. The curriculum blends theoretical learning with practical training in reporting, editing, photography, videography, and media production. Through projects, internships, and hands-on newsroom activities, students gain real-world experience and develop strong communication, storytelling, and technical skills. Graduates are prepared for roles such as reporters, editors, content creators, PR executives, social media managers, and communication specialists in media, corporate, and creative sectors.
                     </p>
                    </div>
