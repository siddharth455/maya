<?php
$page_title = "MCA AI & ML in Dehradun | Maya Devi University";
$page_description = "Enroll in MCA Artificial Intelligence & Machine Learning at Maya Devi University, Dehradun with real-world AI project training.";
$canonical_url = "https://maya.edu.in/mca-aiml.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/aiml-2.webp);">
        <div class="container">
            <h2>MCA Specialization in Artificial Intelligence & Machine Learning</h2>
            <p>The Master of Computer Applications (MCA) with a Specialization in Artificial Intelligence and Machine Learning (AIML) is a cutting-edge postgraduate program designed to meet the evolving demands of the tech industry. This two-year program provides students with an advanced understanding of computer applications, while offering specialized knowledge in the transformative fields of AI and ML.</p>
        </div>
    </div>
