<?php
$page_title = "B.Sc Information Technology in Dehradun | Maya Devi University";
$page_description = "Study B.Sc Information Technology at Maya Devi University, Dehradun with industry-focused IT training and modern computer labs.";
$canonical_url = "https://maya.edu.in/bachelor-of-science-in-information-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/it.webp);">
        <div class="container">
            <h2>BSc in Information Technology (IT)</h2>
            <p>The Bachelor of Science in Information Technology (B.Sc. IT) with a Specialization in Information Technology is a three-year undergraduate program designed to provide students with a strong foundation in computer science along with specialized knowledge in IT systems and infrastructure.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>Bsc IT</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : BSc in Information Technology (IT)</h5>
                                <p>This program equips students with the skills needed to design, develop, and manage IT solutions that support businesses and organizations in today's digital world.</p>
                                <p>Graduates are well-prepared for diverse career opportunities in IT support, system administration, network management, software development, and technical consulting across industries such as IT services, finance, healthcare, and government.</p>
                                <p>The curriculum combines core IT concepts such as programming, database management, and networking with advanced topics like cloud computing, cybersecurity, software development, and system administration. Through practical labs, projects, and industry interactions, students gain hands-on experience to solve real-world IT challenges.</p>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Pass with 50% aggregate marks in 10+2 (with English) or equivalent.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-diamond"></i> 120</span>
                                    </div>
                                    <div class="single-course-summary">
                        ...
                        <div class="single-course">
                            ...
                            <div class="single-course">
                                ...
                                <div class="course-content">
                                    ...
                                    <p>BCA program specializing in cyber security for protecting IT systems and data.</p>
                                </div>
                                <div class="course-position-content">
                                    <div class="credit-duration-wrap">
                                        <div class="sin-credit-duration">
                            ...
                            <div class="single-course">
                                ...
                                <h4><a href="bachelor-of-science-in-computer-science.php">B.Sc. Computer Science</a></h4>
                                    <p>Program covering core computer science concepts, programming, and system design.</p>
                                </div>
                                <div class="course-position-content">
                                    <div class="credit-duration-wrap">
                                        <div class="sin-credit-duration">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Sc. IT program equips students with strong technical skills in information technology, software development, and emerging digital solutions. Supported by modern labs and expert faculty, the program blends theoretical learning with practical projects and industry exposure. Graduates are prepared for careers in IT services, data science, AI, and other fast-growing technology domains worldwide.</p>
                   ...
                   <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Strong foundation in Computer Applications and IT
                                        Industry-oriented curriculum with practical exposure
                                        Focus on programming, databases, web, and emerging technologies.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Enhances problem-solving and analytical skills
                                        Prepares students for higher studies and IT careers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>System Analyst / IT Support Executive</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Opportunities in IT firms, startups, and government sectors</p>
                            </div>
                        </div>
                    </div>
            </div>
