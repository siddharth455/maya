...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/data-science.webp);">
        <div class="container">
            <h2>BCA with Specialization in Data Science</h2>
            <p>The Bachelor of Computer Applications (BCA) with a Specialization in Data Science is a forward- looking three-year undergraduate program designed to meet the growing demand for data-driven decision-making across industries. This program combines foundational computer science education with specialized training in data analysis, statistics, and emerging technologies.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>BCA Data Science</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : BCA with Specialization in Data Science</h5>
                                <p>Graduates of this program are equipped to pursue dynamic careers as Data Analysts, Business Intelligence Developers, Data Engineers, or Junior Data Scientists. With data becoming central to innovation and strategy in every field—from business and healthcare to finance and marketing—this specialization ensures students are job-ready in a data-first world.</p>
                                <p>Students gain core skills in programming, database systems, and software development, while the Data Science specialization introduces them to key areas such as data mining, machine learning, data visualization, big data analytics, and statistical modeling. The curriculum is enhanced through practical lab sessions, real-world projects, and industry-oriented tools like Python, R, SQL, and Power BI.</p>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="single-course">
                                ...
                                <h4><a href="bachelor-of-computer-application.php">bachelor of computer application (BCA)</a></h4>
                                    <p>Undergraduate program in computer applications, focusing on software development and IT skills.</p>
                                </div>
