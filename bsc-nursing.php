<?php
$page_title = "B.Sc Nursing College in Dehradun | Maya Devi University";
$page_description = "Enroll in B.Sc Nursing at Maya Devi University, Dehradun with hospital-based clinical training and expert faculty guidance.";
$canonical_url = "https://maya.edu.in/bsc-nursing.php";
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <p>This program prepares students for professional careers in nursing, equipping them with the knowledge and skills required to provide comprehensive patient care. Graduates can work as Registered Nurses, Community Health Nurses, or pursue advanced studies and specialized roles in areas such as pediatric, psychiatric, or critical care nursing, contributing to healthcare delivery in hospitals, clinics, and community settings.</p>
                            <p>The curriculum combines foundational medical sciences—such as anatomy, physiology, microbiology, and biochemistry—with core nursing subjects like fundamentals of nursing, medical-surgical nursing, community health nursing, midwifery, and child health nursing. Through clinical training, hands-on practicums, and real-world hospital experience, students develop the competence, confidence, and compassion needed to provide high-quality nursing care in diverse healthcare environments.</p>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>10+2 with PCB & English Core/English Elective with aggregate of 45% marks from recognized board.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>The minimum age shall be 17 years on 31st December of the year in which admission is sought.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>andidates must have studied Physics, Chemistry, and Biology as main subjects</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Develop clinical competencies and critical thinking in nursing practice.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Apply evidence-based care in diverse healthcare settings.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Demonstrate leadership and ethical decision-making in patient care.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Prepare for national and international licensure exams.</p>
                                        </div>
                                    </div>
                                </div>
                    </div>
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Staff Nurse in hospitals and clinics - Provide direct patient care in various healthcare settings.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Public Health Nurse - Work in community health programs and public health initiatives.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Eligible for international placements (e.g., NCLEX, HAAD) - Work abroad with proper licensure.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Clinical Nurse Specialist - Specialize in specific areas of nursing practice.</p>
                                        </div>
                                    </div>
                                </div>
