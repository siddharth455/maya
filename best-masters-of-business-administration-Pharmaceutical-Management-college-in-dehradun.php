...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/mba-pharma.jpg);">
        <div class="container">
            <h2>Masters of Business Administration - Pharmaceutical Management</h2>
            <p>The Master of Business Administration (MBA) in Pharmaceutical Management is a two-year postgraduate program designed to develop advanced skills in Pharmaceutical Management, leadership, and organizational development.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>MBA (Pharmaceutical Management)</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/mba-pharma.jpg" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : Masters of Business Administration - Pharmaceutical Management</h5>
                           <p>Our Master of Business Administration (MBA) in Pharmaceutical Management program at Maya Devi University is designed to meet the evolving needs of the pharmaceutical and healthcare industry. Students gain in-depth knowledge and practical skills in pharmaceutical marketing, healthcare management, drug regulatory affairs, supply chain management, and strategic pharmaceutical operations.</p>
<p>An MBA in Pharmaceutical Management provides a strong foundation for careers in pharmaceutical marketing, product management, healthcare consulting, regulatory affairs, hospital administration, and pharma supply chain management. Core subjects such as Pharmaceutical Marketing, Healthcare Management, Drug Regulatory Affairs, Pharmaceutical Supply Chain, Strategic Management, and Pharmaceutical Sales Management form the backbone of the program and prepare students for leadership roles in the Pharmaceutical Management sector.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Master of Business Administration (MBA) in Pharmaceutical Management program provides in-depth knowledge and practical training in pharmaceutical marketing, healthcare operations, drug regulatory affairs, pharmaceutical supply chain management, product lifecycle management, and strategic healthcare planning. Graduates are prepared for careers in pharmaceutical marketing and sales management, product management, regulatory affairs, hospital administration, healthcare consulting, and pharma supply chain leadership, contributing to innovation and growth in the pharmaceutical and healthcare sector.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Pharmaceutical marketing and sales management</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Healthcare systems and hospital management</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Regulatory affairs and quality compliance</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Pharma supply chain and operations</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Ethics and governance in healthcare</p>
                                        </div>
                                    </div>
                                </div>
                    </div>
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Product Manager (Pharmaceuticals)</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Regulatory Affairs Executive</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Supply Chain Manager (Pharma)</p>
                                        </div>
                                    </div>
                                </div>
