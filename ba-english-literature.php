<?php
$page_title = "BA English Literature in Dehradun | Maya Devi University";
$page_description = "Study BA English Literature at Maya Devi University, Dehradun and develop strong communication, analytical, and literary skills.";
$canonical_url = "https://maya.edu.in/ba-english-literature.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ba-3.webp);">
        <div class="container">
            <h2>B.A. in English Literature</h2>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ba-3.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.A. in English Literature</h5>
                               <p>The course prepares students to become skilled writers, critics, educators, and communicators. Through debates, seminars, workshops, and literary activities, learners develop strong analytical thinking, creative expression, and overall personality development. Graduates can pursue careers in schools, colleges, media houses, publishing industries, cultural organizations, NGOs, and academic institutions.</p> <p>The Bachelor of Arts (B.A.) in English Literature program provides students with a comprehensive understanding of the English language, classical and modern literature, literary theories, and global cultural contexts. The curriculum blends theoretical learning with exposure to poetry, prose, drama, fiction, and contemporary writings. Students develop strong linguistic, analytical, and interpretative skills essential for appreciating and contributing to English literature.</p> <p>Through projects, fieldwork, literary discussions, and interactions with authors and scholars, learners gain practical experience and enhance their critical and creative abilities. The program emphasizes cultural awareness, effective communication, and literary appreciation, preparing graduates for roles such as English teachers, content writers, editors, journalists, researchers, and cultural program coordinators in educational, media, and literary organizations.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                       ...
                       <p>The Bachelor of Arts (B.A.) in English Literature program at Maya Devi University provides students with a strong foundation in English language, classical and modern literature, and literary analysis. The curriculum blends theoretical learning with practical exposure to poetry, prose, drama, fiction, and contemporary writings. Through projects, literary discussions, and fieldwork, students gain real-world experience and develop analytical, creative, and communication skills. Graduates are prepared for roles such as English teachers, content writers, editors, journalists, and research assistants in educational, media, and cultural settings.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Advanced understanding of literary works, critical theories, and historical contexts that influence texts</p>
                                </div>
                            </div>
                             <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Ability to teach a variety of genres such as poetry, drama, novels, and short stories</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Skills in educating students on literary analysis, comprehension, and critical thinking</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Graduates can opt for jobs in both public and private sector organizations such as Teacher, Blogger, Content writer, Travel Writer, Public Relations Officer, A student with B.A. English  can pursue careers in Advertising and Marketing, HR and administrative jobs, Editors and Content Managers, Translators as well as in Civil Services.</p>
                            </div>
                        </div>
