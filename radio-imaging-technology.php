<?php
$page_title = "Radio Imaging Technology Course in Dehradun | Maya Devi University";
$page_description = "Study Radio Imaging Technology at Maya Devi University, Dehradun with advanced radiology lab training.";
$canonical_url = "https://maya.edu.in/radio-imaging-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/rit.webp);">
        <div class="container">
            <h2>B.Sc. in Radio Imaging Technology</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. RIT</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. in Radio Imaging Technology</h5>
                                <p>It focuses on the operation and management of advanced imaging technologies such as X-ray, CT, MRI, and Ultrasound. Core subjects include medical imaging techniques, radiology, anatomy, patient positioning, and radiation safety. Students learn to operate imaging equipment, capture diagnostic images, and assist in clinical procedures. The curriculum emphasizes practical training, imaging protocols, and maintaining safety standards.</p> 
                                <p>Hands-on labs and clinical internships enhance technical skills. The program promotes precision, adherence to medical protocols, and professional ethics. Research and training with healthcare partners provide real-world exposure. Graduates are prepared for roles as radiology technicians, imaging specialists, and diagnostic assistants in hospitals, diagnostic centers, and healthcare facilities.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Sc. RIT (B.Sc. in Radio Imaging Technology) program provides comprehensive knowledge and practical training in medical imaging, radiology techniques, and diagnostic procedures. Graduates are prepared for careers as radiology technicians, imaging specialists, and diagnostic assistants, contributing to accurate and efficient healthcare services in hospitals and diagnostic centers.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Proficiency in operating imaging machines.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understanding of radiation safety and patient care.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Ability to assist in diagnostic procedures.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Skills in radiographic anatomy and positioning.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Knowledge of image acquisition techniques.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Competence in equipment maintenance.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Ethical practice and patient confidentiality.</p>
                                </div>
                            </div>
                    ...
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Radiology technician in hospitals and imaging centers</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Research and development in imaging technology</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Radiology department supervisor</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
