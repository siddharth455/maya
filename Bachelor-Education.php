...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/education.jpg);">
        <div class="container">
            <h2>Bachelor of Education (B.Ed.)</h2>
            <p>Bachelor of Education (B.Ed.) is a professional undergraduate degree that prepares individuals to become teachers. It is typically pursued after completing a bachelor's degree (like B.A., B.Sc., or B.Com), and the course duration is usually 2 years in India.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Ed.</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : Bachelor of Education (B.Ed.)</h5>
                            <p>This specialization prepares students for rewarding careers in education. Graduates can work as Teachers, Educational Coordinators, Curriculum Developers, or pursue higher studies in education and specialized training programs.</p> 
                            <p>The curriculum integrates foundational subjects—such as psychology, sociology, and pedagogy—with core education subjects like teaching methodology, classroom management, educational assessment, and curriculum design. Through teaching practice, internships, workshops, and practical training, students gain hands-on experience and develop the instructional, leadership, and research skills necessary to excel in diverse educational settings.</p> 
                            <p>Students also learn innovative teaching techniques, inclusive education strategies, and the use of technology in the classroom. This prepares them to engage students effectively and foster a positive learning environment that promotes critical thinking and creativity.</p>
                             <p>The program emphasizes professional ethics, educational policies, and continuous professional development, ensuring that graduates are not only skilled educators but also responsible mentors and leaders in the education sector.</p>
                              <p>With a B.Ed degree, graduates have opportunities in schools, educational institutions, coaching centers, and online education platforms. They can also contribute to curriculum development, educational research, and policy-making, shaping the future of education both locally and globally.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Ed program trains students in teaching skills, pedagogy, and classroom management, preparing them for careers as teachers and education professionals.</p>
