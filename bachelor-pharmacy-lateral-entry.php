<?php
$page_title = "B.Pharm Lateral Entry in Dehradun | Maya Devi University";
$page_description = "Apply for B.Pharm Lateral Entry at Maya Devi University, Dehradun with modern pharmaceutical labs and strong industry exposure.";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/pharmacy-le.jpg);">
        <div class="container">
            <h2>Bachelor of Pharmacy(Lateral Entry)</h2>
            <p>The B. Pharm Lateral Entry program allows Diploma in Pharmacy (D.Pharm) holders to gain direct admission into the 2nd year of the 4-year B.Pharm program, reducing the duration to 3 years.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Pharmacy (Lateral Entry)</span></li>
            </ul>
        </div>
    </div>
</div>
...
<p>The B.Pharm (Lateral Entry) provides a strong foundation for careers in community and hospital pharmacies, pharmaceutical research and development, regulatory affairs, and healthcare organizations. Core subjects such as Pharmacology, Pharmaceutics, Pharmaceutical Chemistry, Pharmacognosy, and Clinical Pharmacy form the backbone of the program and prepare students for professional practice in pharmacy.</p>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Completion of D.Pharm after 12th standard.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
