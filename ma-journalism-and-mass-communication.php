<?php
$page_title = "MA Journalism & Mass Communication in Dehradun | Maya Devi University";
$page_description = "Enroll in MA Journalism & Mass Communication at Maya Devi University, Dehradun with advanced social research training and academic excellence.";
$canonical_url = "https://maya.edu.in/ma-journalism-and-mass-communication.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ma-10.jpg);">
        <div class="container">
            <h2>M.A. in Journalism & Mass Communication</h2>
            <p>The School of Arts and Humanities at Maya Devi University offers a two year full-time M.A. in Journalism & Mass Communication, divided into four semesters.</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ma-10.jpg" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.A. in Journalism & Mass Communication</h5>
                       <p>The course prepares students to become skilled journalists, media professionals, communication specialists, content creators, and researchers in the field of mass communication. Through lectures, newsroom training, media workshops, case studies, field reporting, and research-based learning, learners develop strong communication skills, critical thinking, ethical awareness, and a deep understanding of media practices and their societal impact. Graduates can pursue careers in print media, television, radio, digital platforms, advertising agencies, public relations firms, corporate communication departments, and government information services.</p> <p>The Master of Arts (M.A.) in Journalism &amp; Mass Communication program provides students with a strong foundation in reporting and editing, broadcast journalism, digital media, media law and ethics, advertising, public relations, and media research. The curriculum integrates theoretical knowledge with practical training in media production and content creation, enabling students to analyze media trends, craft compelling narratives, and engage diverse audiences across traditional and new media platforms.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                  ...
                  <p>The Master of Arts (M.A.) in Journalism &amp; Mass Communication program at Maya Devi University provides students with a strong foundation in reporting and editing, broadcast journalism, digital media production, advertising, public relations, media law and ethics, and communication research. The curriculum integrates theoretical study with practical newsroom training, content creation, media production techniques, and research-oriented learning, enabling students to analyze media landscapes, craft impactful stories, and respond to contemporary communication challenges. Through seminars, workshops, studio practice, internships, field assignments, supervised projects, and interactive sessions, students gain hands-on experience and develop professional, creative, and research skills.</p>
                    </div>
