...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/b-tech-cs.jpeg);">
        <div class="container">
            <h2>B.Tech CSE with Specialization Cyber Security</h2>
            <p>The field is related to protection of computer system, computer network and protection against theft and damage of electronic data stored on cloud, breaching of security system of banking, financial units, leaking of important information related to national security etc.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech Cyber Security</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Tech CSE with Specialization Cyber Security</h5>
                                <p>With internet, wireless system and data storage on clouds, the field is gaining special attention by various government and private agencies, to ensure security against such miscreants who are involved in cyber crime. Common cyber threats include Malware, Backdoors, Cryptojacking, DNS, DDOS, Form jacking etc.</p>
                                <p>There is a huge demand of cyber experts who are involved in protecting the infrastructure security, Network security, cloud security, IoT security as well as application security. Owing to this, Maya Devi University offers specialization in field of cyber security to students enrolled in the undergraduate program B.Tech CSE.</p>
<p>After successful completion of the program B.Tech CSE with Cyber Security, students can explore career as Security Engineer, Cryptographer, Security Analyst, Security Architect, Security Software Developer, Cryptanalyst, and Security Consultant. They can also get an opportunity to work in IT Firms, Tech Firms, Software Development Firms, IT Security Firms, Computer Security Firms, IT Consultancies etc.</p>
                        ...
                        <div class="related-slider-active">
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-CSE.php"><img class="animated" src="assets/img/course/related-course-1.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-AI-ML.php"><img class="animated" src="assets/img/course/related-course-2.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-data_science.php"><img class="animated" src="assets/img/course/related-course-3.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-LE.php"><img class="animated" src="assets/img/course/related-course-2.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Incident Response Specialist</p>
                                        </div>
                                    </div>
