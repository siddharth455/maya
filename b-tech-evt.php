<?php
$page_title = "B.Tech Electric Vehicle Technology in Dehradun | Maya Devi University";
$page_description = "Study B.Tech in Electric Vehicle Technology at Maya Devi University, Dehradun with modern automotive labs and future-ready curriculum.";
$canonical_url = "https://maya.edu.in/b-tech-evt.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/evt.jpg);">
        <div class="container">
            <h2>B.Tech. in Electric Vehicle Technology (EVT)</h2>
            <p>The B.Tech. in Electric Vehicle Technology (EVT) is a forward-looking engineering program that equips students with the knowledge and skills needed to lead the global transition towards sustainable transportation.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech EVT</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Tech. in Electric Vehicle Technology (EVT)</h5>
                                <p>This program blends core concepts from electrical engineering, electronics, mechanical systems, and advanced EV technologies such as battery management, power electronics, electric drivetrains, thermal management, and intelligent vehicle systems. Students gain hands-on experience through specialized EV laboratories, industry-aligned internships, and real-time projects on EV components, charging infrastructure, and energy storage technologies.</p>
                                <p>The Electric Vehicle sector is witnessing exceptional growth, driven by government initiatives, global climate goals, and rapid technological advancements. India’s EV industry alone is projected to create over 10 million jobs by 2030, ranging from engineering and R&D roles to manufacturing and charging infrastructure development.</p>
                                ...
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-diamond"></i> 115</span>
                                    </div>
                                    <div class="single-course-summary">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Tech in Electric Vehicle Technology (EVT) focuses on developing future-ready engineers skilled in electric mobility and sustainable transportation systems. The program provides a strong foundation in EV design, battery technology, power electronics, charging infrastructure, and advanced vehicle systems. Supported by state-of-the-art laboratories and experienced faculty, the curriculum blends theoretical knowledge with hands-on training, research projects, and industry collaborations. Graduates are well-prepared for careers in EV manufacturing, battery management, charging network development, automotive R&D, and other rapidly growing sectors in the global electric mobility ecosystem.</p>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>EV Manufacturing Companies (Electric cars, bikes, buses, and 3-wheelers)</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Battery & Energy Storage Industries</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Power Electronics & Motor Design Firms</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>EV Testing, Validation & Diagnostics</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Green-Tech & Clean Mobility Startups</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Government & Policy Organizations </p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Charging Infrastructure Companies</p>
                                        </div>
                                    </div>
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Battery Management System (BMS) Engineer</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Power Electronics Engineer</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Charging Infrastructure Engineer</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>EV System Integration Specialist</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>EV Service & Diagnostics Engineer</p>
                                        </div>
                                    </div>
                                </div>
