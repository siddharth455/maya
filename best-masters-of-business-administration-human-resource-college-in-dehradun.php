<?php
$page_title = "MBA (HR) College in Dehradun | Maya Devi University";
$page_description = "Join MBA (HR) at Maya Devi University, Dehradun with industry-focused curriculum, leadership training, and strong placement support.";
$canonical_url = "https://maya.edu.in/best-masters-of-business-administration-human-resource-college-in-dehradun.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/mba-hr.jpg);">
        <div class="container">
            <h2>Masters of Business Administration - Human Resource</h2>
            <p>The Master of Business Administration (MBA) in Human Resource Management is a two-year postgraduate program designed to develop advanced skills in human resource management, leadership, and organizational development.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>MBA (HR)</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/mba-hr.jpg" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : Masters of Business Administration - Human Resource</h5>
                           <p>Our Master of Business Administration (MBA) in Human Resource Management program at Maya Devi University is designed to meet the evolving needs of modern organizations and the corporate sector. Students gain in-depth knowledge and practical skills in talent management, organizational behavior, and strategic human resource practices.</p>
<p>An MBA in Human Resource Management provides a strong foundation for careers in recruitment and talent acquisition, employee relations, training and development, compensation and benefits, and HR analytics. Core subjects such as Organizational Behavior, Human Resource Planning, Performance Management, Labor Laws, and Strategic HRM form the backbone of the program and prepare students for leadership roles in human resource management.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Master of Business Administration (MBA) in Human Resource Management program provides in-depth knowledge and practical training in talent acquisition, organizational behavior, performance management, labor laws, and strategic HR practices. Graduates are prepared for careers in recruitment and staffing, employee relations, training and development, compensation and benefits, and HR analytics, contributing to effective workforce management and organizational growth.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Strategic human resource planning and talent management</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Recruitment, training, and performance management systems</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>HR analytics and digital HR practices</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Leadership and organizational development focus</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Labor laws, industrial relations, and compliance</p>
                                        </div>
                                    </div>
                                </div>
                    </div>
