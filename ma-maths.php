<?php
$page_title = "MA Mathematics in Dehradun | Maya Devi University";
$page_description = "Enroll in MA Mathematics at Maya Devi University, Dehradun with advanced social research training and academic excellence.";
$canonical_url = "https://maya.edu.in/ma-maths.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ba-11.webp);">
        <div class="container">
            <h2>M.A. in Mathematics</h2>
            <p>The School of Arts and Humanities at Maya Devi University offers a two year full-time M.A. in Mathematics, divided into four semesters.</p>
        </div>
    </div>
        ...
        <div class="row">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.A. in Mathematics</h5>
                        <p>The course prepares students to become skilled mathematicians, educators, researchers, analysts, and professionals in quantitative fields. Through lectures, seminars, problem-solving sessions, supervised practical work, and research-based learning, learners develop analytical thinking, logical reasoning, and a deep understanding of mathematical concepts and applications. Graduates can pursue careers in educational institutions, research organizations, financial services, data analytics firms, government agencies, and technology companies.</p> <p>The Master of Arts (M.A.) in Mathematics program provides students with a strong foundation in pure and applied mathematics, including algebra, real and complex analysis, topology, differential equations, statistics, and mathematical modeling. The curriculum integrates theoretical knowledge with practical problem-solving approaches, enabling students to apply mathematical principles to real-world problems in science, technology, economics, and industry.</p>
                                ...
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-clock-o"></i> 1/2 Year</span>
                                    </div>
                                    <div class="single-course-summary">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                   ...
                   <p>The Master of Arts (M.A.) in Mathematics program at Maya Devi University provides students with a strong foundation in pure and applied mathematics, including algebra, real and complex analysis, topology, differential equations, statistics, and mathematical modeling. The curriculum integrates theoretical study with practical problem-solving, analytical reasoning, and research-oriented learning, enabling students to apply mathematical concepts to scientific, technological, and real-world challenges. Through seminars, tutorials, supervised projects, workshops, internships, research assignments, and interactive sessions, students gain hands-on experience and develop teaching, analytical, and professional skills.</p>
                    </div>
