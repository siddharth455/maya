<?php
$page_title = "Master in Agriculture in Dehradun | Maya Devi University";
$page_description = "Join Master in Agriculture at Maya Devi University, Dehradun with advanced research and modern agricultural practices.";
$canonical_url = "https://maya.edu.in/master-in-agriculture.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/agriculture.webp);">
        <div class="container">
            <h2>Master of Science in Agriculture</h2>
            <p>Master of Science (M.Sc.) in Agronomy is an advanced postgraduate program designed for those passionate about shaping the future of agriculture.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. agri</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Master of Science in Agriculture</h5>
                                <p>The Master of Science in Agriculture program provides advanced knowledge and research-oriented expertise in modern agricultural practices, including crop production, soil science, horticulture, agricultural economics, and farm management. Students gain both theoretical insights and practical skills essential for careers in agriculture research, agribusiness, and academia.</p> <p>Hands-on training in experimental farms, laboratories, and research projects enhances analytical, technical, and managerial competencies. The program emphasizes sustainable farming practices, innovation, and scientific approaches to agriculture. Internships, field studies, and collaborative research with leading agricultural organizations prepare graduates for roles as agricultural scientists, researchers, consultants, and specialists in the agriculture and food sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Master of Science in Agriculture program provides advanced knowledge and practical training in modern agricultural practices, crop production, soil management, and sustainable farming techniques. Graduates are prepared for careers as agricultural researchers, farm managers, agribusiness specialists, and consultants, contributing to innovation and efficiency in the agriculture and food sectors.</p>
                    </div>
