<?php
$page_title = "B.Tech Mechanical Engineering (Lateral Entry) in Dehradun | Maya Devi University";
$page_description = "Apply for B.Tech Mechanical Engineering Lateral Entry at Maya Devi University, Dehradun with advanced practical training.";
$canonical_url = "https://maya.edu.in/mechanical-engineering-le.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/mechanical-le.webp);">
        <div class="container">
            <h2>B.Tech in Mechanical Engineering (Lateral Entry)</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech Mechanical (Lateral Entry)</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : B.tech Mechanical Engineering (Lateral Entry)</h5>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidate shall have Passed Diploma in Mechanical engineering.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
