<?php
$page_title = "B.Sc Environmental Science in Dehradun | Maya Devi University";
$page_description = "Study B.Sc Environmental Science at Maya Devi University, Dehradun with focus on sustainability and environmental research.";
$canonical_url = "https://maya.edu.in/bsc-environmental-science.php";
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/evs.jpg" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. Environmental Science</h5>
                                <p>Maya Devi University’s B.Sc. Environmental Science program provides comprehensive learning in ecology, biodiversity, environmental chemistry, pollution control, and sustainable resource management. The course combines scientific concepts with field training, research projects, laboratory experiments, and case studies to build strong analytical and problem-solving skills.</p>
                                <p>Students gain practical exposure through environmental surveys, industrial visits, GIS learning, and conservation activities. The program aims to create environmentally conscious professionals capable of addressing modern environmental challenges and contributing to sustainable development across various sectors.</p>
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>10+2 with Science stream (Physics, Chemistry, Biology/Mathematics) from a recognized board with a minimum of 45% marks.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidates must possess interest in environmental studies, ecology, and sustainability-related subjects.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to quality education, modern infrastructure, and research-driven learning. With expert faculty, equipped laboratories, and real-world exposure, the university focuses on skill development, innovation, and ethical values. We aim to produce knowledgeable, confident, and socially responsible graduates who contribute effectively to industry, research, and environmental sustainability.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Study ecology, biodiversity, pollution control, environmental laws, and climate science.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Hands-on learning via laboratory work, field surveys, nature camps, and research projects.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Skill development in environmental assessment, GIS, EIA, data analysis, and conservation.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepares students for higher studies, research careers, government jobs, and NGO roles.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Environmental Consultant / Advisor – Guide industries in eco-friendly and sustainable practices.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Environmental Scientist / Researcher – Work in labs, institutions, and environmental research bodies.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Pollution Control & Waste Management Officer – Work with government boards and environmental agencies.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Forest / Wildlife / Conservation Officer – Serve in biodiversity protection and forestry (with exams).</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>NGO and Sustainability Program Specialist – Work with global and national environment-focused organizations.</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Higher Studies & Specializations – M.Sc., MBA (Environmental Management), GIS & Remote Sensing, Wildlife Science, etc.</p>
                            </div>
                        </div>
                    </div>
