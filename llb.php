<?php
$page_title = "LLB Course in Dehradun | Maya Devi University";
$page_description = "Enroll in LLB program at Maya Devi University, Dehradun with comprehensive legal education and practical training.";
$canonical_url = "https://maya.edu.in/llb.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/llb-3.jpeg);">
        <div class="container">
            <h2>LLB (Bachelor of Law)</h2>
            <p>The LLB is a 3-year graduate-level program tailored for students who have already completed an undergraduate degree in any discipline. It offers a focused legal education that covers the core areas of law such as constitutional law, criminal law, and civil procedure.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>LLB</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : LLB (Bachelor of Law)</h5>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s LL.B program equips students with essential knowledge and practical skills in law, governance, and justice. Supported by experienced faculty, moot court sessions, internships, legal aid clinics, and practical training, the program blends theoretical learning with real-world exposure. Graduates are prepared for careers as advocates, legal advisors, corporate lawyers, and academicians, while also contributing to the development of justice and legal services in society.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Comprehensive understanding of legal principles.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Preparation for litigation and judiciary.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Legal research and drafting skills.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Strong foundation in constitutional and criminal law.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Courtroom advocacy and procedural knowledge.</p>
                                        </div>
                                    </div>
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Advocate - Practice law in courts and represent clients.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Legal Advisor - Provide legal consultation and advice.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Legal Analyst - Analyze legal documents and cases.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Legal Researcher - Conduct research in legal matters.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Legal Consultant - Work as independent legal consultant.</p>
                                        </div>
                                    </div>
                                </div>
