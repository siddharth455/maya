<?php
$page_title = "Public Health Course in Dehradun | Maya Devi University";
$page_description = "Study Public Health at Maya Devi University, Dehradun with healthcare management and community health training.";
$canonical_url = "https://maya.edu.in/public-health.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/bph.webp);">
        <div class="container">
            <h2>Bachelor in Public Health (BPH)</h2>
            <p>The curriculum blends theoretical foundations with practical applications in epidemiology, health promotion, policy, and environmental health.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>BPH</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Bachelor in Public Health (BPH)</h5>
                                <p>Core subjects include public health principles, epidemiology, health promotion, healthcare management, biostatistics, and community health. Students learn to design, implement, and evaluate public health programs, promote population health, and manage healthcare initiatives in community and clinical settings. The curriculum emphasizes leadership, policy planning, and evidence-based health interventions.</p>
<p>Hands-on training, fieldwork, research projects, and internships enhance practical, analytical, and managerial skills. The program focuses on professionalism, communication, and organizational efficiency. Graduates are prepared for roles as public health specialists, community health officers, health program managers, and healthcare consultants in hospitals, NGOs, government agencies, and international health organizations.</p>
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidates requires passing 10+2  from a recognised board minimum marks often 50%.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Bachelor of Public Health (BPH) program provides in-depth knowledge and practical training in public health, community health management, and healthcare program administration. Graduates are prepared for careers as public health specialists, community health officers, and healthcare program managers, contributing to effective health interventions and improved population health outcomes.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>The Bachelor of Public Health (BPH) programme equips students with foundational knowledge and practical skills in community health, disease prevention, and health promotion. The course focuses on public health principles, epidemiology, environmental health, health education, and basic research methods. It emphasizes fieldwork, community engagement, and ethical practice. Graduates are prepared for entry-level public health roles, community-based work and higher studies.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Community health officer (support roles), health educator, program assistant, field investigator, public health coordinator, NGO project assistant, health data assistant, and positions in government health programs, non-governmental organizations, research projects, and community health initiatives. </p>
                            </div>
                        </div>
                    </div>
