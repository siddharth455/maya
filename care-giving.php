<?php
$page_title = "Care Giving Course in Dehradun | Maya Devi University";
$page_description = "Enroll in Care Giving course at Maya Devi University, Dehradun with practical healthcare training.";
$canonical_url = "https://maya.edu.in/care-giving.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/paramedical.webp);">
        <div class="container">
            <h2>Certificate Course in Care Giving</h2>
            <p>The Certificate Course in Care Giving is a short-term professional program designed to train individuals to assist elderly persons, patients, children with special needs, or individuals requiring support in daily living activities. The course focuses on developing essential caregiving skills such as personal care, mobility assistance, basic first aid, emotional support, hygiene management, and understanding the needs of vulnerable populations.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Certificate Course in Care Giving</span></li>
            </ul>
        </div>
    </div>
</div>
                                ...
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Must have completed 10th or 10+2 from a recognized board (varies by institution).</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Basic knowledge of English or the regional language.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Strong willingness to work with elderly, patients, or individuals with special needs.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Certificate Course in Care Giving aims to create trained, compassionate, and reliable care providers who can support individuals requiring day-to-day assistance. Our program blends theoretical knowledge with practical training to build confident caregivers capable of handling real-life caregiving responsibilities with sensitivity and professionalism.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Comprehensive training in elderly care, patient care, and disability support</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Practical sessions on personal hygiene, bathing, feeding, dressing, and grooming</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Training in basic nursing skills such as vital-sign monitoring and medication assistance</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Knowledge of nutrition, mobility exercises, and safe transfer techniques</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Exposure to hospital, rehabilitation, or home-care environments</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Emphasis on empathy, communication, emotional support, and ethical caregiving</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understanding of infection control, emergency response, and first aid</p>
                                </div>
                            </div>
                    ...
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Home Caregiver / Home Health Aide</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Elderly Caregiver in Old-Age Homes</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Hospice or Palliative Care Support Worker</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Care Assistant for persons with disabilities</p>
                            </div>
                        </div>
