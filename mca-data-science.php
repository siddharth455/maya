<?php
$page_title = "MCA Data Science in Dehradun | Maya Devi University";
$page_description = "Join MCA Data Science at Maya Devi University, Dehradun with analytics tools, machine learning, and real-world projects.";
$canonical_url = "https://maya.edu.in/mca-data_science.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/mca-data.webp);">
        <div class="container">
            <h2>MCA Specialization in Data Science</h2>
            <p>The Master of Computer Applications (MCA) with a Specialization in Data Science is a two-year postgraduate program designed to equip students with advanced knowledge and skills in handling, analyzing, and interpreting vast amounts of data. This specialization combines core computer applications education with in-depth training in data analytics, big data technologies, machine learning, and statistical modeling.</p>
        </div>
    </div>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Pass with 55% aggregate marks in Bachelor's degree (any discipline) or equivalent.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                   ...
                   <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Open to graduates from any discipline with 55% aggregate marks</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Strong foundation in computer science and application development</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Industry-oriented curriculum with practical and project-based learning</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Focus on emerging technologies and problem-solving skills</p>
                                </div>
                            </div>
                             <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepares students for both technical and analytical roles</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Data Analyst / System Analyst</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>IT Support & Network Executive</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Opportunities in IT companies, startups, and government sectors</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Higher studies and research options available</p>
                            </div>
                        </div>
                    </div>
            </div>
