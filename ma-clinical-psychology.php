<?php
$page_title = "MA Clinical Psychology in Dehradun | Maya Devi University";
$page_description = "Study MA Clinical Psychology at Maya Devi University, Dehradun with advanced mental health training and research exposure.";
$canonical_url = "https://maya.edu.in/ma-clinical-psychology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ma-3.webp);">
        <div class="container">
            <h2>M.A. in Clinical Psychology</h2>
            <p>The School of Arts and Humanities at Maya Devi University offers a two year full-time M.A. in Clinical Psychology, divided into four semesters.</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ma-3.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.A. in Clinical Psychology</h5>
                        <p>The course prepares students to become skilled clinical psychologists, researchers, and mental health professionals. Through lectures, seminars, workshops, supervised practical training, and clinical exposure, learners develop diagnostic skills, therapeutic insight, and a deep understanding of mental health and psychological disorders. Graduates can pursue careers in hospitals, mental health clinics, rehabilitation centers, NGOs, research organizations, and healthcare institutions.</p> <p>The Master of Arts (M.A.) in Clinical Psychology program provides students with a strong foundation in psychopathology, psychological assessment, psychotherapy, counseling techniques, and mental health interventions. The curriculum integrates theoretical knowledge with clinical practice, enabling students to understand, assess, and manage psychological disorders and emotional well-being.</p> <p>Through clinical internships, case studies, research projects, seminars, and interactions with mental health professionals, learners gain hands-on experience and applied clinical skills. The program prepares graduates for roles such as clinical psychologists, counselors, mental health therapists, research assistants, and clinical coordinators in clinical, academic, and community-based settings.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                   ...
                   <p>The Master of Arts (M.A.) in Clinical Psychology program at Maya Devi University provides students with a strong foundation in psychopathology, psychological assessment, psychotherapy, and counseling techniques. The curriculum integrates theoretical study with clinical, practical, and research-oriented learning, enabling students to understand, assess, and manage mental health disorders and emotional well-being. Through seminars, clinical internships, case studies, research projects, and interactive sessions, students gain hands-on experience and develop critical thinking, diagnostic, and professional skills.</p>
                    </div>
