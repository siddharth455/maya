<?php
$page_title = "B.Tech Aerospace Engineering in Dehradun | Maya Devi University";
$page_description = "Pursue B.Tech Aerospace Engineering at Maya Devi University, Dehradun with cutting-edge labs, research opportunities, and industry-focused curriculum.";
$canonical_url = "https://maya.edu.in/b.tech-aerospace-engineering.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/aero.jpg);">
        <div class="container">
            <h2>B.Tech in Aerospace Engineering</h2>
            <p>B. Tech in Aerospace Engineering is a 4-year undergraduate program that deals with the design, development, testing, and maintenance of aircraft, spacecraft, missiles, and related systems and equipment.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech Aerospace</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/aero.jpg" alt="banner">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : B.tech Aerospace Engineering</h5>
                            <p>Our Aerospace Engineering degrees from Maya Devi University are aligned with the dynamic advancements in aviation, space exploration, and the rapidly evolving aerospace industry. Students gain knowledge and skills across a broad spectrum of aerospace engineering topics.</p>
<p>A degree in Aerospace Engineering opens the door to a profession with diverse career opportunities in aviation, defense, and space research. Core subjects such as Aerodynamics, Propulsion, Aircraft Structures, Flight Mechanics, and Space Technology form the backbone of studies and provide a strong foundation in aerospace engineering principles.</p>
                        ...
                        <div class="related-slider-active">
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="mechanical-engineering-le.php"><img class="animated" src="assets/uploads/mechanical-le.webp" alt="Course Image"></a>
                                </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Tech Aerospace Engineering program provides technical expertise and practical training in aerodynamics, propulsion, and aircraft systems. Graduates are prepared for careers in aviation, defense, and space research, contributing to innovation and advancements in aerospace technology.</p>
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>High Demand in Defense and Aviation Sectors</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Growth in Commercial Space Industry</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Opportunities in Emerging Fields</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Cross-disciplinary Career Options</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Competitive and Specialized Field</p>
                                        </div>
                                    </div>
                                </div>
