<?php
$page_title = "Dialysis Technology Course in Dehradun | Maya Devi University";
$page_description = "Enroll in Dialysis Technology course at Maya Devi University, Dehradun with clinical training and hospital-based practical exposure.";
$canonical_url = "https://maya.edu.in/dialysis-technology.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/dialysis.webp);">
        <div class="container">
            ...
            <p>The Diploma in Dialysis Technology is a focused, career-oriented program designed to train students in the operation and management of dialysis equipment and the care of patients undergoing renal replacement therapy.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Diploma in Dialysis</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : Diploma in Dialysis Technology</h5>
                            ...
                            <p>Hands-on labs and clinical internships enhance practical skills. The program encourages precision, patient safety, and adherence to medical protocols. Research and training with healthcare partners provide professional exposure. Graduates are prepared for roles as dialysis technicians, clinical assistants, and healthcare support professionals in dialysis centers and hospitals.</p>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>10+2 with PCB with minimum 50% marks (General) and 45% (SC/ST)</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidates must have completed Class 12th from a recognized board</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
