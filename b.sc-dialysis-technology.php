<?php
$page_title = "B.Sc Dialysis Technology in Dehradun | Maya Devi University";
$page_description = "Study B.Sc Dialysis Technology at Maya Devi University, Dehradun with clinical exposure, modern labs, and hospital-based practical training.";
$canonical_url = "https://maya.edu.in/b.sc-dialysis-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/dialysis.webp);">
        <div class="container">
            <h2>B.Sc. in Dialysis Technology</h2>
            <p>The B.Sc. in Dialysis Technology program trains students in dialysis procedures, equipment management, and patient care for renal treatment.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. in Dialysis</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/dialysis.webp" alt="banner">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : B.Sc. in Dialysis Technology</h5>
                            <p>Core subjects include human anatomy, physiology, dialysis technology, infection control, and patient care. Students learn to operate dialysis machines, monitor patients, and manage dialysis procedures safely. The curriculum emphasizes practical training, clinical procedures, and handling emergency situations in dialysis care.</p> 
                            <p>Hands-on labs and clinical internships enhance practical skills. The program encourages precision, patient safety, and adherence to medical protocols. Research and training with healthcare partners provide professional exposure. Graduates are prepared for roles as dialysis technicians, clinical assistants, and healthcare support professionals in dialysis centers and hospitals.</p>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="single-course">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="radio-imaging-technology.php"><img class="animated" src="assets/uploads/rit.webp" alt="Course Image"></a>
                                </div>
                                <div class="course-content">
                                ...
                                <div class="course-position-content">
                                    ...
                                    <div class="course-btn">
                                        <a class="default-btn" href="radio-imaging-technology.php.php">APPLY NOW</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Diploma in Dialysis program provides comprehensive knowledge and practical training in dialysis technology, patient care, and clinical procedures. Graduates are prepared for careers as dialysis technicians, clinical assistants, and healthcare support professionals, contributing to safe and effective renal care in hospitals and dialysis centers.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Competence in dialysis procedures and equipment.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Understanding of renal physiology and patient safety.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Ability to manage dialysis sessions independently.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Skills in patient monitoring and care.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Knowledge of infection control protocols.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Emergency response and complication management.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Professional communication and patient education.</p>
                                        </div>
                                    </div>
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Dialysis technician in hospitals and nephrology clinics</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Home dialysis care provider</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Technician in renal research labs</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Medical device sales representative</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
