<?php
$page_title = "M.Sc. Zoology | Maya Devi University Dehradun";
$page_description = "The M.Sc. Zoology program is designed to provide advanced knowledge and research skills in animal biology, physiology, ecology, genetics, biotechnology, and...";
$canonical_url = "https://maya.edu.in/msc-zoology.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>M.Sc. Zoology</h2>
            <p>The M.Sc. Zoology program is designed to provide advanced knowledge and research skills in animal biology, physiology, ecology, genetics, biotechnology, and environmental science. It emphasizes laboratory techniques, field studies, and scientific analysis, preparing graduates for careers in research institutions, wildlife departments, healthcare, education, and advanced studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Zoology</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.Sc. Zoology</h5>
                                <p>The M.Sc. Zoology program at Maya Devi University offers a comprehensive understanding of animal sciences. The curriculum includes animal physiology, genetics, molecular biology, biotechnology, ecology, evolution, taxonomy, biostatistics, immunology, parasitology, microbiology, and environmental biology.</p>
                                <p>Students receive extensive hands-on experience through laboratory work, dissections, ecological surveys, field studies, microscopy, and research-based projects. The program enhances students’ analytical thinking, scientific inquiry, and practical skills, preparing them for careers in research labs, wildlife conservation, environmental agencies, healthcare sectors, and academia.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to providing excellence in postgraduate education through specialized laboratories, expert faculty, and research-driven learning. The university focuses on hands-on training, innovation, and scientific exploration to build strong analytical and technical abilities in students. Our mission is to prepare research-oriented, environmentally aware, and professionally skilled zoologists who contribute to wildlife conservation, healthcare, environmental sustainability, and scientific research at national and international levels.</p>
                    </div>
