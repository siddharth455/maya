<?php
$page_title = "B.Voc Hotel & Hospitality in Dehradun | Maya Devi University";
$page_description = "Join B.Voc Hotel and Hospitality Management at Maya Devi University, Dehradun and build a successful career in hospitality industry.";
$canonical_url = "https://maya.edu.in/b.voc-hotel-hospitality.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/hotel.webp);">
        <div class="container">
            <h2>B.Voc Hotel & Hospitality Management</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc Hotel & Hospitality Management</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/hotel.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Hotel & Hospitality Management</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Hotel & Hospitality Management program equips students with practical knowledge and professional skills essential for success in the global hospitality and service industry. The curriculum combines theoretical learning with hands-on training in front office operations, housekeeping, food and beverage management, culinary arts, and customer service excellence. Students develop strong interpersonal, managerial, and operational skills required to deliver high-quality guest experiences and manage hospitality services efficiently.</p> <p>Through live training, internships, and industry collaborations with hotels and resorts, learners gain real-world experience in hospitality management, event coordination, and tourism operations. The program emphasizes professionalism, innovation, and leadership, preparing graduates for careers as hotel managers, front office executives, food service supervisors, and event coordinators in hotels, resorts, airlines, and the travel and tourism industry.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Hotel & Hospitality Management program at Maya Devi University offers a skill-based and industry-oriented curriculum designed to prepare students for rewarding careers in the hospitality, tourism, and service sectors. The program combines classroom learning with practical training in front office management, food and beverage operations, housekeeping, and customer service. Students develop strong communication, managerial, and organizational skills required to excel as hospitality professionals, hotel executives, and event coordinators in leading hotels, resorts, and tourism establishments.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Manage hotel departments efficiently.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Deliver exceptional guest experiences.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Plan and execute hospitality events.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understand hospitality laws and ethics.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Gain exposure to global hospitality practices.</p>
                                </div>
                            </div>
                        </div>
                    </div>
