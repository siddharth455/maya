<?php
$page_title = "BA Geography in Dehradun | Maya Devi University";
$page_description = "Study BA Geography at Maya Devi University, Dehradun with focus on environmental studies, mapping, and spatial analysis.";
$canonical_url = "https://maya.edu.in/ba-geography.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ba-9.webp);">
        <div class="container">
            <h2>B.A. in Geography</h2>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ba-9.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.A. in Geography</h5>
                           <p>The course prepares students to become skilled geographers, environmental analysts, educators, and planners. Through field surveys, workshops, seminars, and practical activities, learners develop strong analytical abilities, spatial understanding, and overall personality development. Graduates can pursue careers in environmental agencies, government departments, research organizations, GIS companies, schools, NGOs, and urban planning institutions.</p> <p>The Bachelor of Arts (B.A.) in Geography program provides students with a strong foundation in physical geography, human geography, climatology, cartography, and environmental studies. The curriculum combines theoretical knowledge with hands-on training in map reading, GIS techniques, remote sensing, and field data collection. Students develop spatial awareness, research skills, and analytical thinking essential for understanding the relationship between people, places, and the environment.</p> <p>Through fieldwork, research projects, internships, and interactions with geographers and environmental experts, learners gain real-world experience and enhance their practical and technical skills. The program prepares graduates for roles such as geography teachers, GIS analysts, surveyors, research assistants, environmental planners, and cartographers in educational, governmental, and environmental sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                     ...
                     <p>The Bachelor of Arts (B.A.) in Geography program at Maya Devi University provides students with a strong foundation in physical and human geography, climatology, cartography, and environmental studies. The curriculum blends theoretical learning with practical training in GIS, remote sensing, map interpretation, and field surveying. Through projects, internships, and hands-on fieldwork, students gain real-world experience and develop analytical, technical, and research skills. Graduates are prepared for roles such as GIS analysts, surveyors, geography teachers, research assistants, and environmental planners in educational, governmental, and environmental sectors.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>An understanding of how cities and towns develop, grow, and function over time.</p>
                                </div>
                            </div>
                             <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Knowledge of urban systems, zoning laws, land use policies, infrastructure, and sustainability challenges.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Skills in planning, designing, and implementing land-use policies to improve urban spaces and address challenges like traffic, pollution, and housing.</p>
                                </div>
                            </div>
                        </div>
                    </div>
