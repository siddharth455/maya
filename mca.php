<?php
$page_title = "MCA College in Dehradun | Maya Devi University";
$page_description = "Pursue MCA at Maya Devi University, Dehradun with advanced programming, software development, and IT industry training.";
$canonical_url = "https://maya.edu.in/mca.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/mca.webp);">
        <div class="container">
            <h2>Master of Computer Applications (MCA)</h2>
            <p>Computer Application involves application of computer software like word processing, efficient use of spreadsheet, internet, desktop publishing, and windows operating system. Business organization look for graduate who are proficient in the field of computer application that is prominently used for Budgeting, Sales, Forecasting, employ database management, stock maintenance as well as payroll calculations.</p>
        </div>
    </div>
