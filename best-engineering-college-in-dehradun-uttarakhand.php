<?php
$page_title = "Best Engineering College in Dehradun Uttarakhand | Maya Devi University";
...
<section class="section-pad event-area-maya">
  <div class="container">
    <div class="reveal mb-4">
      ...
      <h2 class="section-maya text-white">Latest From <em>School of Engineering</em></h2>
    </div>
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12 mb-4">
        <div class="dept-blog-card">
          ...
          <div class="dept-blog-body">
            ...
            <p class="dept-blog-excerpt">Pursue B.Tech & M.Tech in Civil, Mechanical, Electrical & Electronics at Maya Devi University, a top engineering college in Dehradun...</p>
            <div class="dept-blog-footer">
              <span class="dept-blog-date"><i class="fa fa-calendar-o"></i> Jan 25, 2026</span>
              <a href="engineering-at-maya-devi-university.php" class="dept-blog-btn">Read Full Article &rarr;</a>
            </div>
          </div>
        </div>
      </div>
