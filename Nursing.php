...
<section class="section-pad event-area-maya">
  <div class="container">
    <div class="reveal mb-4">
      ...
      <h2 class="section-maya text-white">Latest From <em>School of Nursing</em></h2>
    </div>
    <div class="row">
      ...
      <div class="col-lg-3 col-md-12 mb-4">
        <div class="dept-blog-card">
          ...
          <div class="dept-blog-body">
            ...
            <p class="dept-blog-excerpt">Study GNM & B.Sc Nursing at Maya Devi University, a leading nursing college in Dehradun, Uttarakhand with modern labs, clinical training & career support...</p>
            <div class="dept-blog-footer">
              <span class="dept-blog-date"><i class="fa fa-calendar-o"></i> Feb 10, 2026</span>
              <a href="nursing-at-maya-devi-university.php" class="dept-blog-btn">Read Full Article &rarr;</a>
            </div>
          </div>
        </div>
      </div>
