<?php
$page_title = "MA Environmental Science in Dehradun | Maya Devi University";
$page_description = "Enroll in MA Environmental Science at Maya Devi University, Dehradun with advanced social research training and academic excellence.";
$canonical_url = "https://maya.edu.in/ma-evs.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ma-11.jpg);">
        <div class="container">
            <h2>M.A. in Environmental Science</h2>
            <p>The School of Arts and Humanities at Maya Devi University offers a two year full-time M.A. in Environmental Science, divided into four semesters.</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ma-11.jpg" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.A. in Environmental Science</h5>
                       <p>The course prepares students to become skilled environmental professionals, researchers, sustainability consultants, policy analysts, and conservation specialists. Through lectures, seminars, field studies, laboratory work, case studies, and research-based learning, learners develop scientific knowledge, analytical skills, and a deep understanding of environmental systems and sustainability challenges. Graduates can pursue careers in environmental agencies, research organizations, NGOs, government departments, sustainability firms, and international environmental bodies.</p> <p>The Master of Arts (M.A.) in Environmental Science program provides students with a strong foundation in ecology, environmental management, climate change, biodiversity conservation, environmental policy, natural resource management, and sustainable development. The curriculum integrates theoretical knowledge with practical fieldwork, laboratory analysis, and research methodologies, enabling students to assess environmental issues, design sustainable solutions, and contribute effectively to environmental protection and policy-making at local, national, and global levels.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                  ...
                  <p>The Master of Arts (M.A.) in Environmental Science program at Maya Devi University provides students with a strong foundation in ecology, environmental management, climate change studies, biodiversity conservation, environmental policy, natural resource management, and sustainable development. The curriculum integrates theoretical study with fieldwork, laboratory analysis, environmental impact assessment, and research-oriented learning, enabling students to understand environmental challenges and develop sustainable solutions at local, national, and global levels. Through seminars, field visits, supervised research projects, workshops, internships, laboratory sessions, and interactive discussions, students gain practical exposure and develop scientific, analytical, and professional skills.</p>
                    </div>
