<?php
$page_title = "Food Technology Course in Dehradun | Maya Devi University";
$page_description = "Study Food Technology at Maya Devi University, Dehradun with advanced food science labs and industry-focused curriculum.";
$canonical_url = "https://maya.edu.in/food-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/food.webp);">
        <div class="container">
            <h2>Bachelor of Science in Food Technology</h2>
            <p>The Bachelor of Food Technology program equips students with in-depth knowledge and hands-on skills in food processing, preservation, quality assurance, and modern food production techniques.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. Food</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Bachelor of Food Technology program provides comprehensive knowledge and practical training in food processing, preservation, quality control, and modern production techniques. Graduates are prepared for careers as food technologists, quality analysts, product developers, and researchers, contributing to innovation and efficiency in the food industry.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Understand the basic principles of food science, preservation and safety.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Apply standard food processing techniques and quality control methods.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Follow regulatory guidelines (FSSAI, ISO) in handling and processing food products.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Gain practical exposure suitable for entry-level roles or further academic studies.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Communicate scientific information effectively and work in team settings.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Eligible for M.Sc. programs in Food Science, Nutrition, or Biotechnology</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Technical Assistant in R&D labs</p>
                            </div>
                        </div>
                    </div>
