...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>Bachelor of Science (B.Sc.) Hons. in Botany</h2>
            <p>The B.Sc. (Hons.) Botany program is designed to provide advanced knowledge of plant biology, ecology, genetics, and biotechnology. It emphasizes practical laboratory work, field research, and scientific investigation, preparing graduates for specialized careers and higher studies in plant sciences, agriculture, environment, and biotechnology sectors in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Bachelor of Science (B.Sc.) Hons. in Botany</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Bachelor of Science (B.Sc.) Hons. in Botany</h5>
                                <p>The B.Sc. (Hons.) in Botany program at Maya Devi University offers a specialized and comprehensive study of plant sciences, focusing on advanced subjects such as plant anatomy, physiology, taxonomy, biotechnology, ecology, genetics, molecular biology, and environmental interactions.</p>
                                <p>The honors curriculum includes deeper theoretical modules, extensive laboratory experiments, field explorations, herbarium techniques, ecological research, and an honors-level project work. The program enhances students' scientific thinking, observational skills, and problem-solving abilities. It prepares students for research, higher studies, competitive exams, and professional roles in agriculture, biotechnology, forestry, pharmaceuticals, and environmental sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to excellence in life sciences education through modern laboratories, qualified faculty, and research-focused learning. The university encourages practical training, innovation, and environmental awareness by offering hands-on projects, field studies, and plant research opportunities. Our mission is to develop highly skilled, confident, and research-oriented graduates who contribute to scientific development, biodiversity conservation, and agricultural advancement at national and international platforms.</p>
                    </div>
