<?php
$page_title = "B.Tech ECE (Lateral Entry) in Dehradun | Maya Devi University";
$page_description = "Apply for B.Tech Electronics and Communication Engineering Lateral Entry at Maya Devi University, Dehradun with advanced labs and industry-ready curriculum.";
$canonical_url = "https://maya.edu.in/b.tech-electronics-and-communication-engineering-le.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/b.tech-electric-2.webp);">
        <div class="container">
            <h2>B.Tech in Electronics and <br>Communication Engineering<br>(Lateral Entry)</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech EC Engineering (Lateral Entry)</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/b.tech-electric-2.webp" alt="banner">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                <h4>COURSE  DETAILS: B.Tech in Electronics and Communication Engineering (Lateral Entry)</h4>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidate shall have Passed Diploma in Electronics engineering.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="single-course">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b-tech-civil-structural-engineering.php"><img class="animated" src="assets/uploads/b.tech-civil.jpg" alt="Course Image"></a>
                                </div>
                                <div class="course-content">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Tech Electronics and Communication Engineering (Lateral Entry) program offers practical training in robotics, AI, and automation, preparing graduates for careers in smart systems and technology innovation.</p>
                    </div>
