<?php
$page_title = "B.Tech Lateral Entry Admission in Dehradun | Maya Devi University";
$page_description = "Apply for B.Tech Lateral Entry at Maya Devi University, Dehradun and join directly in second year with industry-focused engineering programs.";
$canonical_url = "https://maya.edu.in/b.tech-LE.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/b-tech-le.webp);">
        <div class="container">
            <h2>B.Tech CSE Lateral Entry with Specializations</h2>
            <p>The Bachelor of Technology in Computer Science and Engineering (B.Tech CSE) Lateral Entry with specializations in Artificial Intelligence & Machine Learning, Data Science, and Cyber Security is a comprehensive undergraduate program designed to provide students with a strong theoretical foundation along with advanced practical skills in emerging technology domains.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech LE</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Tech CSE Lateral Entry with Specialization AI/ML, Data Science & Cyber Security</h5>
                                <p>The Bachelor of Technology (B.Tech) in Computer Science and Engineering (Lateral Entry) with specializations in Artificial Intelligence & Machine Learning (AI & ML), Data Science, and Cyber Security is a future-focused undergraduate program designed to strengthen core computer science fundamentals while providing advanced knowledge and practical expertise in high-demand technology domains. The program enables diploma holders to directly join the second year and specialize in cutting-edge fields.</p>

                                <p>This program emphasizes key areas such as machine learning, deep learning, data analytics, big data technologies, network security, cryptography, ethical hacking, natural language processing, and intelligent systems. The curriculum combines theoretical learning with hands-on projects, lab work, and industry exposure to foster innovation and real-world problem solving.</p>

                                <p>Graduates are equipped with strong analytical thinking, technical proficiency, and ethical awareness—preparing them to excel in industries such as AI & ML, data science, cyber security, fintech, healthcare, and automation, and to lead advancements in next-generation technologies.</p>
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Pass with 45% aggregate marks in Diploma (Engg.) (any stream) 3 years after 10th Or 2 years after 10+2 (Non-Medical) Or B.Sc. (Non-Medical) Or B.Sc. (Computer Science) Or BCA or equivalent, </p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-diamond"></i> 127</span>
                                    </div>
                                    <div class="single-course-summary">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Tech in Computer Science and Engineering (Lateral Entry) with specializations in Artificial Intelligence & Machine Learning, Data Science, and Cyber Security equips students with advanced technical skills in programming, software development, and emerging technologies. Designed for diploma holders entering directly into the second year, the program provides a strong academic and practical foundation in specialized domains.</p>
                    </div>
