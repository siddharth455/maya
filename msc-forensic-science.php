<?php
$page_title = "M.Sc Forensic Science in Dehradun | Maya Devi University";
$page_description = "Enroll in M.Sc Forensic Science at Maya Devi University, Dehradun with advanced forensic lab training.";
$canonical_url = "https://maya.edu.in/msc-forensic-science.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/forensic-3.webp);">
        <div class="container">
            <h2>M.Sc. Forensic Science</h2>
            <p>The M.Sc. Forensic Science program is designed to provide advanced expertise in crime investigation, evidence analysis, forensic biology, forensic chemistry, toxicology, and criminalistics. It emphasizes laboratory research, scientific accuracy, and investigative skills, preparing graduates for professional roles in forensic labs, law enforcement agencies, research institutions, and higher studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Forensic Science</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/forensic-3.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.Sc. Forensic Science</h5>
                                <p>The M.Sc. Forensic Science program at Maya Devi University provides specialized and comprehensive training in modern forensic techniques. The curriculum includes forensic biology, forensic chemistry, toxicology, DNA profiling, serology, ballistics, fingerprint analysis, cyber forensics, questioned document examination, forensic psychology, and crime scene management.</p>
                                <p>Students gain hands-on experience through laboratory experiments, evidence analysis, crime scene reconstructions, case study evaluations, and research-based projects. The program focuses on scientific reasoning, critical thinking, and technical proficiency, preparing students for roles in forensic labs, investigative agencies, forensic consultancy, and academic research.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to offering high-quality postgraduate education in forensic science through advanced laboratories, experienced faculty, and real-world investigative training. The university emphasizes hands-on learning, crime scene simulation, evidence handling, and analytical techniques. Our mission is to produce highly skilled, ethical, and research-driven forensic professionals who contribute effectively to crime investigation, justice systems, and scientific advancements at national and global levels.</p>
                    </div>
