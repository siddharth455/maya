...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>B.Sc. Forensic Science (Hons.)</h2>
            <p>The B.Sc. (Hons.) Forensic Science program is designed to provide advanced scientific and investigative skills required for crime detection, evidence analysis, and legal investigations. It emphasizes laboratory research, crime scene examination, forensic biology, forensic chemistry, and analytical techniques, preparing graduates for specialized careers in forensic labs, law enforcement, and higher studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. Forensic Science (Hons.)</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. Forensic Science (Hons.)</h5>
                                <p>The B.Sc. (Hons.) Forensic Science program at Maya Devi University offers a comprehensive and specialized study of forensic techniques used in criminal investigation and evidence analysis. The curriculum includes advanced forensic biology, forensic chemistry, toxicology, ballistics, serology, DNA profiling, fingerprint analysis, cyber forensics, documentation examination, and forensic psychology.</p>
                                <p>Students gain extensive hands-on experience through laboratory experiments, mock crime scene investigations, case study analysis, evidence handling, and research-based projects. The honors program adds depth through specialized electives, seminars, and a dedicated research project, preparing graduates for advanced roles in investigative agencies, forensic laboratories, cybercrime units, and legal support services.</p>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="related-slider-active">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="bsc-biotechnology-hons.php"><img class="animated" src="assets/uploads/bsc-pcm-img1.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to excellence in forensic education through advanced laboratories, highly qualified faculty, and industry-driven learning. The university emphasizes hands-on investigation, scientific accuracy, and analytical reasoning by offering crime scene simulations, forensic tools training, and practical exposure. Our mission is to develop skilled, confident, and ethically responsible forensic professionals who contribute effectively to crime investigation, justice systems, and scientific research at national and international levels.</p>
                    </div>
