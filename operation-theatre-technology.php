<?php
$page_title = "Operation Theatre Technology in Dehradun | Maya Devi University";
$page_description = "Study Operation Theatre Technology at Maya Devi University, Dehradun with hands-on surgical training exposure.";
$canonical_url = "https://maya.edu.in/operation-theatre-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ott.webp);">
        <div class="container">
            <h2>B.Sc. in Operation Theatre Technology</h2>
            <p>The B.Sc.OTT program is a specialized undergraduate course designed to train students in the critical operations of surgical environments.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. OTT</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. in Operation Theatre Technology (BOTT)</h5>
                                <p>It prepares students to assist surgeons, anesthesiologists, and nursing staff during surgical procedures by ensuring that the operation theatre is sterile, organized, and equipped with the necessary instruments and technology.Core subjects include surgical procedures, operation theatre technology, patient care, anesthesia basics, and sterilization techniques. Students learn to assist in surgeries, manage operation theatre equipment, and ensure patient safety. The curriculum emphasizes practical training, procedural protocols, and maintaining hygiene and safety standards.</p> 
                                <p>Hands-on labs and clinical internships enhance technical skills. The program promotes precision, adherence to medical protocols, and professional ethics. Training with healthcare partners provides real-world exposure. Graduates are prepared for roles as operation theatre technicians, surgical assistants, and healthcare support professionals in hospitals and surgical centers.</p>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="single-course">
                            ...
                            <div class="single-course">
                                ...
                                <div class="course-content">
                                <h4><a href="medical-lab-technology.php">B.Sc. in Medical Lab Technology</a></h4>
                                <p>The program promotes precision, adherence to medical protocols, and professional ethics. Research and training with healthcare partners provide real-world exposure.</p>
                                </div>
                                <div class="course-position-content">
                                    <div class="credit-duration-wrap">
                                        <div class="sin-credit-duration">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Sc. in Operation Theatre Technology program offers in-depth knowledge and hands-on training in surgical procedures, operation theatre management, and anesthesia support. Graduates are equipped for roles as operation theatre technologists, surgical assistants, and healthcare professionals, ensuring safety and efficiency in surgical care.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Assist in various surgical procedures across specialties</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Maintain and operate OT equipment and surgical instruments</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Proficiency in anesthesia support.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Emergency response and trauma care skills.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Infection control and sterilization expertise.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Professional communication and teamwork.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Ethical practice and patient safety.</p>
                                </div>
                            </div>
                    ...
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>OT technician in hospitals and surgical centers</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Sterilization and infection control officer</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Surgical equipment specialist</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Surgical department supervisor</p>
                            </div>
                        </div>
