...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>B.Sc. Environmental Science Hons</h2>
            <p>The B.Sc. Environmental Science (Hons) program is designed to develop students’ scientific knowledge, analytical skills, and practical abilities to understand, evaluate, and address environmental challenges. It focuses on ecological studies, environmental protection, sustainability practices, climate science, pollution control, and research-based learning.</p>
        </div>
    </div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. Environmental Science Hons</h5>
                                <p>The B.Sc. Environmental Science (Hons) program at Maya Devi University is an advanced undergraduate degree designed for students seeking deeper scientific expertise in environmental studies. The curriculum offers comprehensive learning in ecology, environmental chemistry, climate science, biodiversity, environmental policies, GIS & remote sensing, and sustainable development.</p>
                                <p>Through extensive research projects, laboratory work, field surveys, industrial exposure, and conservation activities, students develop critical thinking, analytical, and technical skills. The honors structure provides additional research components and specialization, preparing graduates for advanced research, higher studies, international opportunities, and professional careers in environmental sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is dedicated to providing high-quality, research-focused, and skill-based education through modern facilities and expert faculty. With advanced laboratories, field-based learning, and an innovation-driven curriculum, the university aims to prepare responsible, knowledgeable, and eco-conscious graduates. We emphasize analytical thinking, practical exposure, and global environmental awareness, empowering students to create meaningful impact in sustainability and environmental protection.</p>
                    </div>
