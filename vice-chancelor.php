<?php
$page_title = "Vice Chancelor | Maya Devi University Dehradun";
$page_description = "Message from the Vice Chancellor of Maya Devi University, Dehradun.";
$canonical_url = "https://maya.edu.in/vice-chancelor.php";
...
<section class="maya-president-message">
  <div class="maya-president-wrapper">
    <div class="maya-president-header">
      <h2 class="maya-president-heading">Message from the Vice Chancellor</h2>
