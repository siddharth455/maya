<?php
$page_title = "BCA Cyber Security in Dehradun | Maya Devi University";
$page_description = "Join BCA Cyber Security at Maya Devi University, Dehradun with ethical hacking, network security, and cybersecurity labs.";
$canonical_url = "https://maya.edu.in/bachelor-of-computer-application-cyber-security.php";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>BCA Cyber Security</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : BCA with Specialization in Cyber Security</h5>
                                <p>This specialization opens doors to careers in high-demand fields such as Cyber Security Analyst, Ethical Hacker, Security Consultant, and Information Security Officer. Graduates are equipped to work across industries including IT, finance, defense, healthcare, and government sectors, where data security is a top priority.</p>
                                <p>As cyber threats continue to rise globally, this program prepares students to become the next generation of cyber defense professionals.</p>
                                <p>The curriculum covers core subjects such as programming, database management, and networking, while integrating advanced topics like ethical hacking, digital forensics, cryptography, network security, and cyber law. Through practical labs, case studies, and simulated security scenarios, students gain hands-on experience in identifying vulnerabilities and defending against cyberattacks.</p>
