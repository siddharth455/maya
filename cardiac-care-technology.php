<?php
$page_title = "Cardiac Care Technology Course in Dehradun | Maya Devi University";
$page_description = "Study Cardiac Care Technology at Maya Devi University, Dehradun with hospital-based practical training.";
$canonical_url = "https://maya.edu.in/cardiac-care-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/cardiac.webp);">
        <div class="container">
            <h2>B.Sc. in Cardiac Care Technology</h2>
            <p>It focuses on developing technical expertise in monitoring heart function and assisting in cardiac procedures.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. in Cardiac Care</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. in Cardiac Care Technology</h5>
                                <p>Core subjects include human anatomy, physiology, cardiac anatomy, electrocardiography, and cardiac care technology. Students learn to assist cardiologists in diagnosing and treating heart conditions, operate cardiac equipment, and monitor patients during cardiac procedures. The curriculum emphasizes practical training in cardiac diagnostics, emergency care, and patient management.</p>
                                <p>Hands-on labs and clinical internships enhance technical and clinical expertise. The program focuses on accuracy, patient safety, and adherence to healthcare standards. Research and hospital-based training provide real-world exposure. Graduates are prepared for roles as cardiac care technologists, ECG technicians, and healthcare professionals in hospitals and cardiac centers.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Sc. in Cardiac Care Technology program provides in-depth knowledge and practical training in cardiac diagnostics, patient monitoring, and cardiovascular care. Graduates are prepared for careers as cardiac technologists, ECG technicians, and healthcare professionals, contributing to effective cardiac treatment and patient safety in hospitals and heart care centers.</p>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Operate and maintain cardiac diagnostic equipment such as ECG and echocardiography machines.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Monitor patients during cardiac procedures and emergencies.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Assist cardiologists in diagnostic and therapeutic interventions.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Interpret basic cardiac data and contribute to clinical decision-making.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Maintain accurate patient records and ensure data confidentiality.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Apply safety protocols and infection control measures in cardiac units.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                    ...
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Cardiac Rehabilitation Specialist</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Cardiology Department Coordinator</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Emergency Cardiac Care Assistant</p>
                            </div>
                        </div>
