<?php
$page_title = "Master in Public Health in Dehradun | Maya Devi University";
$page_description = "Pursue Master in Public Health at Maya Devi University, Dehradun with advanced training in healthcare systems and research.";
$canonical_url = "https://maya.edu.in/master-in-public-health.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/mph.webp);">
        <div class="container">
            <h2>Master in Public Health (MPH)</h2>
            <p>It focuses on public health systems, epidemiology, biostatistics, health promotion, and policy development. Students gain the skills to lead health initiatives, conduct impactful research, and influence health policy at local, national, and global levels.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>MPH</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Master in Public Health (MPH)</h5>
                                <p>Maya Devi University’s Master of Public Health (MPH) program provides advanced knowledge and practical training in public health, epidemiology, healthcare management, and community health. Students learn to design, implement, and evaluate health programs, promote population well-being, and manage public health initiatives in community and clinical settings. The curriculum emphasizes leadership, policy planning, and evidence-based interventions.</p>
<p>Hands-on training, fieldwork, research projects, and internships enhance analytical, practical, and managerial skills. Graduates are prepared for roles as public health specialists, community health officers, health program managers, and healthcare consultants in hospitals, NGOs, government agencies, and international health organizations.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Master of Public Health (MPH) program provides advanced knowledge and practical training in public health, epidemiology, health management, and community health initiatives. Graduates are prepared for careers as public health specialists, program managers, health policy advisors, and researchers, contributing to effective health interventions and improved population health outcomes.</p>
