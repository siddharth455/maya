<?php
$page_title = "M.Sc. Chemistry | Maya Devi University Dehradun";
$page_description = "The M.Sc. Chemistry program is designed to provide advanced theoretical and practical knowledge in organic, inorganic, physical, and analytical chemistry. It...";
$canonical_url = "https://maya.edu.in/msc-chemistry.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            ...
            <p>The M.Sc. Chemistry program is designed to provide advanced theoretical and practical knowledge in organic, inorganic, physical, and analytical chemistry. It emphasizes laboratory research, analytical techniques, instrumentation skills, and problem-solving abilities, preparing graduates for careers in chemical industries, pharmaceuticals, research labs, academics, and higher scientific research in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Chemistry</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.Sc. Chemistry</h5>
                                <p>The M.Sc. Chemistry program at Maya Devi University offers in-depth and specialized training across major branches of chemistry. The curriculum includes advanced organic chemistry, inorganic chemistry, physical chemistry, analytical chemistry, spectroscopy, quantum chemistry, polymer science, environmental chemistry, and instrumental methods of analysis.</p>
                                <p>Students gain extensive hands-on experience through laboratory experiments, chemical synthesis, chromatographic techniques, spectroscopy analysis, research projects, and seminars. The program enhances scientific inquiry, experimental accuracy, data analysis, and problem-solving skills, preparing students for research-driven careers, industrial roles, and doctoral studies.</p>
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>B.Sc. with Chemistry as one of the subjects in all the three years from recognized University. For BSc Hons duration of MSc will be one year.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidates must demonstrate strong interest in chemical sciences, laboratory research, and analytical studies.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>No upper age limit; however, applicants must meet university-specific admission rules.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-diamond"></i> 88 for two years and 44 for one year</span>
                                    </div>
                                    <div class="single-course-summary">
                        ...
                        <div class="related-slider-active">
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="msc-physics.php"><img class="animated" src="assets/uploads/bsc-pcm-img1.jpg" alt=""></a>
                                    <span>Post Graduation Course</span>
                                </div>
                                <div class="course-content">
                                    <h4><a href="course-details.php">M.Sc. Physics</a></h4>
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="msc-microbiology.php"><img class="animated" src="assets/uploads/bsc-pcm-img1.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is dedicated to excellence in postgraduate science education through state-of-the-art laboratories, experienced faculty members, and research-oriented learning methods. The university focuses on developing strong scientific expertise, analytical reasoning, and innovative thinking. Our mission is to produce highly skilled chemistry professionals who contribute to industrial growth, scientific research, environmental sustainability, and academic excellence globally.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Choice based credit system(CBCS) based Assessment and evalution . Start -up idea Innovation Lab for career and Professional growth.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Further studies leading to Ph.D  in chemistry or related fields. Technical roles in pharmaceutical  and chemical industries.</p>
                            </div>
                        </div>
                    </div>
                </div>
