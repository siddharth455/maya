<?php
$page_title = "B.Voc Computer Technology in Dehradun | Maya Devi University";
$page_description = "Enroll in B.Voc Computer Technology at Maya Devi University, Dehradun with practical IT training and career-focused technical skills.";
$canonical_url = "https://maya.edu.in/b.voc-computer-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/computer.webp);">
        <div class="container">
            <h2>B.Voc Computer Technology</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc Computer Technology</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Computer Technology</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Computer Technology program equips students with comprehensive technical knowledge and hands-on expertise in modern computing, software development, and IT infrastructure management. The curriculum integrates theoretical foundations with practical training in programming languages, computer networks, database systems, operating systems, and web technologies. Students develop analytical, problem-solving, and technical skills essential for designing, managing, and implementing technology-driven solutions across various industries.</p> <p>Through practical labs, projects, and industry internships, learners gain real-world experience in software development, network administration, and system maintenance. The program emphasizes innovation, technical proficiency, and professional ethics, preparing graduates for careers as software developers, IT support specialists, network administrators, and system analysts in the information technology, business, and research sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Computer Technology program at Maya Devi University offers a skill-based and industry-oriented curriculum designed to prepare students for rewarding careers in information technology, software development, and computer systems management. The program combines classroom learning with practical training in programming, networking, database management, operating systems, and web development. Students develop strong technical, analytical, and problem-solving skills required to excel as software developers, IT professionals, and system administrators across diverse industries.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Develop IT troubleshooting skills.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Learn programming and system management.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understand networking and cybersecurity.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Gain hands-on experience with IT tools.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepare for industry certifications.</p>
                                </div>
                            </div>
                        </div>
                    </div>
