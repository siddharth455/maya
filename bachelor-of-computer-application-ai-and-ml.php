<?php
$page_title = "BCA AI & ML in Dehradun | Maya Devi University";
$page_description = "Enroll in BCA Artificial Intelligence and Machine Learning at Maya Devi University, Dehradun with hands-on AI project training.";
$canonical_url = "https://maya.edu.in/bachelor-of-computer-application-ai-and-ml.php";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>BCA (AIML)</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : BCA with Specialization in Artificial Intelligence and Machine Learning (AIML)</h5>
                                <p>This specialization prepares students for dynamic careers in one of the most promising fields of technology. Graduates can pursue roles such as AI Engineer, Machine Learning Developer, Data Scientist, or NLP Specialist, or continue with higher studies and research in emerging AI technologies.</p>
                                <p>The curriculum blends core computer science subjects—like programming, data structures, and databases—with advanced topics such as machine learning algorithms, deep learning, natural language processing (NLP), computer vision, and data analytics. Through hands-on projects, labs, and real-world applications, students learn to develop intelligent systems that can solve complex problems across industries.</p>
