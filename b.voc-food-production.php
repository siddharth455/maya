<?php
$page_title = "B.Voc Food Production in Dehradun | Maya Devi University";
$page_description = "Enroll in B.Voc Food Production at Maya Devi University, Dehradun with hands-on culinary training and hospitality industry exposure.";
$canonical_url = "https://maya.edu.in/b.voc-food-production.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/food-production.webp);">
        <div class="container">
            <h2>B.Voc Food Production</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc Food Production</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/food-production.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Food Production</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Food Production program equips students with comprehensive knowledge and hands-on expertise in culinary science, food preparation, and kitchen management. The curriculum blends theoretical learning with extensive practical training in modern cooking techniques, bakery and confectionery, food safety, nutrition, and hygiene standards. Students develop the technical and creative skills required to meet the demands of the hospitality and food service industries.</p> <p>Through intensive kitchen training, live projects, and industry internships, learners gain real-world experience in menu planning, food presentation, and commercial kitchen operations. The program emphasizes innovation, quality, and professionalism, preparing graduates for careers as chefs, kitchen supervisors, food production managers, and culinary entrepreneurs in hotels, restaurants, and catering establishments.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Food Production program at Maya Devi University offers a skill-based and industry-focused curriculum designed to prepare students for dynamic careers in the culinary and hospitality sectors. The program blends theoretical learning with extensive practical training in food preparation, kitchen operations, bakery and confectionery, and food safety standards. Students develop the culinary expertise, creativity, and professionalism required to excel as chefs, kitchen supervisors, and food production managers in hotels, restaurants, and catering industries.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Learn food safety and hygiene standards.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Gain culinary and kitchen management skills.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepare a variety of cuisines.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understand food costing and inventory.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Develop presentation and plating techniques.</p>
                                </div>
                            </div>
                        </div>
                    </div>
