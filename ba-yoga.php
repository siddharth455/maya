<?php
$page_title = "BA Yoga in Dehradun | Maya Devi University";
$page_description = "Enroll in BA Yoga at Maya Devi University, Dehradun with professional training in yoga therapy, wellness, and holistic health.";
$canonical_url = "https://maya.edu.in/ba-yoga.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ba-7.webp);">
        <div class="container">
            <h2>B.A. in Yoga</h2>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ba-7.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.A. in Yoga</h5>
                           <p>The course prepares students to become skilled yoga practitioners, instructors, wellness coaches, and holistic health promoters. Through practical sessions, workshops, seminars, and field activities, learners develop physical fitness, mental discipline, and overall personality development. Graduates can pursue careers in yoga studios, wellness centers, schools, fitness institutions, NGOs, and healthcare organizations.</p> <p>The Bachelor of Arts (B.A.) in Yoga program provides students with a strong foundation in yogic philosophy, asanas, pranayama, meditation, and the principles of holistic well-being. The curriculum combines theoretical knowledge with hands-on training in yoga practice, therapeutic techniques, and lifestyle management. Students develop physical, mental, and spiritual awareness essential for promoting health and wellness.</p> <p>Through practical training, internships, workshops, and interactions with yoga experts, learners gain real-world experience and enhance their teaching and therapeutic skills. The program prepares graduates for roles such as yoga instructors, wellness trainers, therapists, and health coordinators in educational, fitness, and healthcare settings.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                     ...
                     <p>The Bachelor of Arts (B.A.) in Yoga program at Maya Devi University provides students with a strong foundation in yogic philosophy, asanas, pranayama, meditation, and holistic health practices. The curriculum blends theoretical learning with practical training in yoga techniques, therapeutic applications, and wellness management. Through workshops, internships, and hands-on sessions, students gain real-world experience and develop physical, mental, and teaching skills. Graduates are prepared for roles such as yoga instructors, wellness trainers, therapists, and health coordinators in fitness centers, schools, and healthcare settings.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Mastery of yoga postures (asanas), breathing techniques (pranayama), meditation practices, and alignment principles.</p>
                                </div>
                            </div>
                             <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Ability to guide students through classes, ensuring they practice yoga safely and effectively.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Development of a deep understanding of the philosophy behind yoga, including concepts like mindfulness, non-violence (ahimsa), and self-discipline (tapas).</p>
                                </div>
                            </div>
                        </div>
                    </div>
