<?php
$page_title = "Pharmacy College in Dehradun | Maya Devi University";
...
<section class="section-pad event-area-maya">
  <div class="container">
    <div class="reveal mb-4">
      ...
      <h2 class="section-maya text-white">Latest From <em>School of Pharmacy</em></h2>
    </div>
    <div class="row">
        ...
        <div class="dept-blog-card">
          <div class="dept-blog-img">
            <a href="pharmacy-at-maya-devi-university.php">
              <img src="assets/uploads/pharmacy-blog.png" alt="A Career in Healthcare Innovation">
            </a>
            <span class="dept-blog-badge">Pharmacy</span>
          </div>
          <div class="dept-blog-body">
            ...
            <p class="dept-blog-excerpt">Study D.Pharm, B.Pharm & M.Pharm at Maya Devi University, a leading pharmacy college in Dehradun, Uttarakhand with modern labs & industry links...</p>
            <div class="dept-blog-footer">
              <span class="dept-blog-date"><i class="fa fa-calendar-o"></i> Jan 30, 2026</span>
              <a href="pharmacy-at-maya-devi-university.php" class="dept-blog-btn">Read Full Article &rarr;</a>
            </div>
          </div>
        </div>
      </div>
