...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>M.Sc. Environmental Science</h2>
            <p>The M.Sc. Environmental Science program is designed to provide advanced knowledge and practical skills in environmental management, ecology, pollution control, climate studies, and sustainability. It emphasizes research, fieldwork, environmental assessment, and analytical techniques, preparing graduates for careers in environmental agencies, industries, research organizations, and higher studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Environmental Science</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.Sc. Environmental Science</h5>
                                <p>The M.Sc. Environmental Science program at Maya Devi University provides an in-depth and specialized study of environmental systems, natural resource management, and pollution monitoring. The curriculum covers environmental chemistry, ecology, biodiversity conservation, environmental impact assessment (EIA), climate science, GIS & remote sensing, waste management, environmental policy, and sustainable development.</p>
                                <p>Students gain hands-on experience through laboratory work, field surveys, environmental sampling, GIS mapping, pollution analysis, and research projects. The program focuses on building scientific reasoning, analytical skills, and technical expertise, preparing students for careers in environmental consultancy, pollution control boards, NGOs, research institutions, and government sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to offering high-quality postgraduate education through modern laboratories, expert faculty, and a research-driven ecosystem. The university emphasizes sustainability-focused learning, field studies, community projects, and environmental awareness. Our mission is to develop skilled, eco-conscious, and research-driven graduates who contribute to environmental protection, climate solutions, ecological conservation, and sustainable development at national and global levels.</p>
                    </div>
