<?php
$page_title = "M.Tech Computer Science Engineering in Dehradun | Maya Devi University";
$page_description = "Pursue M.Tech Computer Science Engineering at Maya Devi University, Dehradun with advanced research and industry-focused training.";
$canonical_url = "https://maya.edu.in/mtech-cse.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/computer.jpg);">
        <div class="container">
            <h2>M.Tech Computer Science & Engineering</h2>
            <p>Advanced postgraduate programs designed to provide cutting-edge knowledge and technical expertise in rapidly evolving fields of computer science engineering. Research-driven curriculum with state-of-the-art labs and industry collaboration.</p>
        </div>
    </div>
