<?php
$page_title = "B.Voc Finance, Taxation & Accounting in Dehradun | Maya Devi University";
$page_description = "Join B.Voc Finance, Taxation and Accounting at Maya Devi University, Dehradun with practical financial management training.";
$canonical_url = "https://maya.edu.in/b.voc-finance-taxation-accounting.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/tax.webp);">
        <div class="container">
            <h2>B.Voc Finance, Taxation & Accounting</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc FT & Accounting</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Finance, Taxation & Accounting</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Finance, Taxation & Accounting program equips students with in-depth financial knowledge and practical expertise in managing business accounts, taxation, and financial operations. The curriculum integrates theoretical foundations with hands-on training in accounting principles, auditing, financial management, direct and indirect taxation, and computerized accounting systems such as Tally and ERP. Students develop analytical, numerical, and decision-making skills essential for maintaining financial accuracy and ensuring regulatory compliance across industries.</p> <p>Through practical training, live projects, and internships with accounting firms and corporate organizations, learners gain real-world experience in tax filing, financial reporting, budgeting, and auditing processes. The program emphasizes precision, professionalism, and ethical financial practices, preparing graduates for careers as accountants, tax consultants, auditors, and financial analysts in the corporate, banking, and government sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Finance, Taxation & Accounting program at Maya Devi University offers a skill-based and industry-oriented curriculum designed to prepare students for professional careers in finance, accounting, auditing, and taxation. The program combines classroom learning with practical training in financial management, corporate accounting, taxation laws, auditing practices, and computerized accounting systems. Students develop strong analytical, numerical, and problem-solving skills required to excel as accountants, tax consultants, auditors, and financial analysts across corporate, banking, and government sectors.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Maintain financial records and reports.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understand tax laws and compliance.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Use accounting software effectively.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepare budgets and financial statements.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Support financial decision-making.</p>
                                </div>
                            </div>
                        </div>
                    </div>
