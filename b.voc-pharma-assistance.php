<?php
$page_title = "B.Voc Pharma Assistance in Dehradun | Maya Devi University";
$page_description = "Join B.Voc Pharma Assistance at Maya Devi University, Dehradun with practical pharmaceutical training and industry-ready curriculum.";
$canonical_url = "https://maya.edu.in/b.voc-pharma-assistance.php";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc Pharma Assistance</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Pharma Assistance</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Pharma Assistance program equips students with practical knowledge and technical expertise essential for supporting pharmaceutical operations and healthcare services. The curriculum combines theoretical learning with hands-on training in drug formulation, dispensing techniques, pharmacology, pharmaceutical calculations, and patient care. Students develop accuracy, ethical responsibility, and communication skills vital for assisting pharmacists and ensuring safe and effective medication management.</p> <p>Through laboratory sessions, internships, and industry exposure, learners gain real-world experience in pharmaceutical practice, inventory control, and healthcare documentation. The program emphasizes precision, professionalism, and industry compliance, preparing graduates for careers as pharmacy assistants, hospital pharmacy technicians, medical representatives, and healthcare support professionals in hospitals, community pharmacies, and pharmaceutical companies.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Pharma Assistance program at Maya Devi University offers a skill-based and industry-focused curriculum designed to prepare students for professional roles in the pharmaceutical and healthcare sectors. The program combines classroom learning with practical training in drug dispensing, pharmacology, pharmaceutical operations, and patient care practices. Students develop the technical, ethical, and communication skills required to excel as pharmacy assistants, medical representatives, and healthcare support professionals in hospitals, clinics, and pharmaceutical companies.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Understand pharmacy operations and regulations.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Assist in clinical and retail pharmacy.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Manage drug inventory and documentation.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Learn patient interaction and counseling.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepare for pharmacy certifications.</p>
                                </div>
                            </div>
                        </div>
                    </div>
