<?php
$page_title = "MA English in Dehradun | Maya Devi University";
$page_description = "Enroll in MA English at Maya Devi University, Dehradun with advanced social research training and academic excellence.";
$canonical_url = "https://maya.edu.in/ma-english.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ma-7.jpg);">
        <div class="container">
            <h2>M.A. in English</h2>
            <p>The School of Arts and Humanities at Maya Devi University offers a two year full-time M.A. in English, divided into four semesters.</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ma-7.jpg" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.A. in English</h5>
                        <p>The course prepares students to become skilled literary scholars, educators, writers, editors, researchers, and communication professionals. Through lectures, seminars, textual analysis, critical discussions, and research-based learning, learners develop analytical thinking, interpretative skills, linguistic competence, and a deep understanding of literature and language. Graduates can pursue careers in educational institutions, publishing houses, media organizations, content development firms, civil services, and corporate communication sectors.</p> <p>The Master of Arts (M.A.) in English program provides students with a strong foundation in British, American, and Indian literature, literary theory and criticism, linguistics, cultural studies, and contemporary literary discourses. The curriculum integrates theoretical knowledge with critical analysis and research-oriented approaches, enabling students to interpret texts across genres and historical periods while understanding their cultural, social, and political contexts.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                  ...
                  <p>The Master of Arts (M.A.) in English program at Maya Devi University provides students with a strong foundation in British, American, Indian, and World literature, along with literary theory, criticism, linguistics, and cultural studies. The curriculum integrates theoretical study with critical analysis, interpretative approaches, and research-oriented learning, enabling students to explore diverse literary texts within their historical, social, and cultural contexts. Through seminars, tutorials, supervised research projects, workshops, internships, paper presentations, and interactive sessions, students gain practical exposure and develop teaching, analytical, writing, and professional skills.</p>
                    </div>
