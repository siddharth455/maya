<?php
$page_title = "BOTT Course in Dehradun | Maya Devi University";
$page_description = "Join BOTT at Maya Devi University, Dehradun with practical training in operation theatre technology.";
$canonical_url = "https://maya.edu.in/bott.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/bott.webp);">
        <div class="container">
            <h2>Bachelor of Operation Theatre Technology</h2>
            <p>The OTT program prepares students to assist surgeons and anesthesiologists. Core areas include Surgical Procedures, Anesthesia Technology, Sterilization, and OT Equipment Handling.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>BOTT</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Bachelor of Operation Theatre Technology (BOTT)</h5>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s BOTT (Bachelor of Operation Theatre Technology) program provides comprehensive knowledge and practical training in surgical procedures, operation theatre management, and patient care. Graduates are prepared for careers as operation theatre technicians, surgical assistants, and healthcare support professionals, contributing to safe and efficient surgical services in hospitals and healthcare centers.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Ability to maintain sterile OT conditions.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Skill in assisting surgical teams.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
