<?php
$page_title = "B.Tech Civil Structural Engineering in Dehradun | Maya Devi University";
$page_description = "Join B.Tech Civil Structural Engineering at Maya Devi University, Dehradun with advanced labs, practical training, and strong placement support.";
$canonical_url = "https://maya.edu.in/b-tech-civil-structural-engineering.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/b.tech-civil.jpg);">
        <div class="container">
            <h2>B.Tech in Civil Engineering (Structural Engineering)</h2>
            <p>The Civil Engineering program with a specialization in Structural Engineering focuses on designing, analyzing, and constructing safe and sustainable structures. Students gain a strong foundation in engineering mathematics, mechanics, and materials science. Core subjects include Structural Analysis, Reinforced Concrete Design, Steel Structures, and Geotechnical Engineering.</p>
        </div>
    </div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/b.tech-civil.jpg" alt="banner">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : B.tech Civil Engineering (Structural Engineering)</h5>
                            <p>This specialization prepares students for advanced and rewarding careers in Structural Engineering. Graduates can work as Structural Engineers, Design Engineers, Project Managers, Consultants, Academicians, or pursue higher research in areas such as earthquake-resistant design, bridge engineering, high-rise structures, and sustainable construction.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Tech Civil Engineering (Structural Engineering) program focuses on structural design, analysis, and construction, preparing graduates for careers in engineering, consulting, and project management.</p>
                    </div>
