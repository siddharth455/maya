...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>M.Sc. Physics</h2>
            <p>The M.Sc. Physics program is designed to develop advanced theoretical, experimental, and research-oriented skills in modern and classical physics. It emphasizes analytical thinking, mathematical modeling, laboratory research, and scientific computing, preparing graduates for careers in research institutions, academia, industry, and advanced scientific fields in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Physics</span></li>
            </ul>
        </div>
    </div>
</div>
                            ...
                            <div class="over-view-content">
                                ...
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-diamond"></i> 44 for one year and 88 for two year</span>
                                    </div>
                                    <div class="single-course-summary">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to delivering high-quality postgraduate education through experienced faculty, advanced laboratories, and research-oriented teaching methods. The university emphasizes innovation, experimentation, and industry-aligned learning. Our mission is to nurture highly skilled, research-ready physicists who contribute to scientific discovery, technology development, and academic excellence globally.</p>
                    </div>
