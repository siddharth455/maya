<?php
$page_title = "Hotel Management & Tourism in Dehradun | Maya Devi University";
  ...
  <div class="row g-4 text-center mt-4">
    ...
    <div class="col-md-3 col-6">
      <div class="stat-card p-4 rounded shadow-sm h-100" style="background:#f6fffa;">
        ...
        <h3 class="fw-bold">
          <span class="counter" data-target="356">356</span>+
        </h3>
...
<section class="section-pad event-area-maya">
  <div class="container">
    <div class="reveal mb-4">
      ...
      <h2 class="section-maya text-white">Latest From <em>School of Hotel & Tourism Management</em></h2>
    </div>
    <div class="row">
        ...
        <div class="dept-blog-card">
          <div class="dept-blog-img">
            <a href="hotel-tourism-management-at-maya-devi-university.php">
              <img src="assets/uploads/hotel-blog.png" alt="A Passport to the World">
            </a>
          </div>
          <div class="dept-blog-body">
            ...
            <p class="dept-blog-excerpt">Study hotel management, culinary arts & tourism at Maya Devi University, a leading hotel management college in Dehradun, Uttarakhand with hands-on training...</p>
            <div class="dept-blog-footer">
              <span class="dept-blog-date"><i class="fa fa-calendar-o"></i> Feb 15, 2026</span>
              <a href="hotel-tourism-management-at-maya-devi-university.php" class="dept-blog-btn">Read Full Article &rarr;</a>
            </div>
          </div>
        </div>
      </div>
