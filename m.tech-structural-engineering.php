<?php
$page_title = "M.Tech Structural Engineering in Dehradun | Maya Devi University";
$page_description = "Enroll in M.Tech Structural Engineering at Maya Devi University, Dehradun with advanced civil research and design training.";
$canonical_url = "https://maya.edu.in/m.tech-structural-engineering.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/m-structure.webp);">
        <div class="container">
            <h2>M.Tech Program (Structural Engineering)</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.tech Structural</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/m-structure.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : M.Tech Program (Structural Engineering)</h5>
                            <p>The Faculty of Engineering offers Two-year M. Tech Program in Structural Engineering aiming to equip students with the knowledge and skills necessary for construction and building design. The Civil Department boasts a team of expert faculty members and resources from prestigious institutions, committed to providing students with both a solid theoretical foundation and practical engineering experience.</p>
                             <p>To further enhance practical skills, the department is equipped with state-of-the-art laboratories and research centers specializing in various subfields of Civil Engineering, including Structural Engineering, Earthquake Engineering, Transportation Engineering, Geotechnical Engineering, Fluid Mechanics, Environmental Engineering, and Concrete Technology. In addition to academic excellence, the department focuses on preparing students for the professional world, helping them develop the career competencies necessary to succeed in the industry.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s M.Tech Structural Engineering program emphasizes advanced concepts in structural design, analysis, and research, preparing postgraduates for careers in specialized engineering, consulting, and academia.</p>
