        ...
        <div class="row">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.A. in Yoga</h5>
                        <p>The course prepares students to become skilled yoga practitioners, instructors, therapists, and wellness professionals. Through lectures, seminars, workshops, supervised practical training, and experiential learning, learners develop physical discipline, mental focus, and a deep understanding of yogic science and holistic health. Graduates can pursue careers in yoga studios, wellness centers, schools, fitness institutions, NGOs, and healthcare organizations.</p> <p>The Master of Arts (M.A.) in Yoga program provides students with a strong foundation in yogic philosophy, asanas, pranayama, meditation, and therapeutic yoga practices. The curriculum integrates theoretical knowledge with practical training, enabling students to promote physical, mental, and spiritual well-being through yoga.</p> <p>Through practical sessions, internships, workshops, research projects, and interactions with yoga experts, learners gain hands-on experience and teaching skills. The program prepares graduates for roles such as yoga instructors, yoga therapists, wellness coaches, researchers, and health coordinators in educational, clinical, and community-based settings.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                   ...
                   <p>The Master of Arts (M.A.) in Yoga program at Maya Devi University provides students with a strong foundation in yogic philosophy, asanas, pranayama, meditation, and therapeutic yoga practices. The curriculum integrates theoretical study with practical, experiential, and research-oriented learning, enabling students to promote physical, mental, and spiritual well-being. Through seminars, practical training, internships, workshops, research projects, and interactive sessions, students gain hands-on experience and develop teaching, analytical, and professional skills.</p>
                    </div>
