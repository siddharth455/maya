<?php
$page_title = "BA Fine Arts in Dehradun | Maya Devi University";
$page_description = "Join BA Fine Arts at Maya Devi University, Dehradun and explore creative expression through painting, design, and visual arts.";
$canonical_url = "https://maya.edu.in/ba-fine-arts.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ba-10.webp);">
        <div class="container">
            <h2>B.A. in Fine Arts</h2>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ba-10.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.A. in Fine Arts</h5>
                          <p>The course prepares students to become skilled artists, designers, illustrators, and creative professionals. Through studio practice, workshops, seminars, and exhibitions, learners develop strong artistic abilities, creative expression, aesthetic understanding, and overall personality development. Graduates can pursue careers in art studios, advertising agencies, design firms, galleries, schools, NGOs, and cultural institutions.</p> <p>The Bachelor of Arts (B.A.) in Fine Arts program provides students with a strong foundation in drawing, painting, sculpture, printmaking, visual communication, and art history. The curriculum combines theoretical learning with hands-on training in various art techniques, creative processes, and contemporary artistic practices. Students develop observational skills, visual thinking, and creative problem-solving abilities essential for professional artistic work.</p> <p>Through practical projects, studio work, internships, exhibitions, and interactions with artists and industry experts, learners gain real-world experience and enhance their technical and creative skills. The program prepares graduates for roles such as professional artists, art teachers, illustrators, designers, gallery assistants, and creative consultants in educational, cultural, and commercial sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                     ...
                     <p>The Bachelor of Arts (B.A.) in Fine Arts program at Maya Devi University provides students with a strong foundation in drawing, painting, sculpture, printmaking, and visual communication. The curriculum blends theoretical learning with practical studio work, enabling students to explore various art techniques, creative processes, and contemporary artistic practices. Through projects, workshops, exhibitions, and internships, students gain real-world experience and develop strong artistic, technical, and creative skills. Graduates are prepared for roles such as professional artists, designers, illustrators, art teachers, and gallery assistants in educational, cultural, and creative sectors.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Development of advanced skills in various forms of artistic expression, including traditional and contemporary media.</p>
                                </div>
                            </div>
                             <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Ability to explore personal creative visions and transform ideas into visual works.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Cultivation of a unique artistic voice and the ability to build a body of work for exhibitions and commercial success.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understanding of artistic techniques, materials, and styles, alongside the ability to experiment and innovate.</p>
                                </div>
                            </div>
                        </div>
                    </div>
