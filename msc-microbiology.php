<?php
$page_title = "M.Sc Microbiology in Dehradun | Maya Devi University";
$page_description = "Join M.Sc Microbiology at Maya Devi University, Dehradun with modern research laboratories.";
$canonical_url = "https://maya.edu.in/msc-microbiology.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/micro.webp);">
        <div class="container">
            <h2>M.Sc. Microbiology</h2>
            <p>The M.Sc. Microbiology program is designed to provide advanced knowledge and research skills in studying microorganisms, molecular biology, immunology, and microbial biotechnology. It emphasizes laboratory techniques, diagnostic methods, and analytical skills, preparing graduates for careers in research labs, healthcare, pharmaceuticals, food industries, and higher scientific studies in India and abroad.</p>
        </div>
    </div>  
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Microbiology</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.Sc. Microbiology</h5>
                                <p>The M.Sc. Microbiology program at Maya Devi University offers comprehensive and specialized learning in microbial science. The curriculum covers microbial physiology, molecular biology, immunology, virology, bacteriology, mycology, microbial genetics, biochemistry, biotechnology, fermentation technology, environmental microbiology, and clinical microbiology.</p>
                                <p>Students receive extensive hands-on training in microbial culturing, staining, microscopy, biochemical testing, molecular techniques (PCR, electrophoresis), enzyme assays, fermentation systems, and advanced diagnostic methods. Through research projects, seminars, lab work, and case studies, the program prepares students for scientific, industrial, clinical, and environmental microbiology roles.</p>
                                ...
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-clock-o"></i> 2 Years (4 Semesters) OR 1 Year (2 Semesters) After B.Sc. (Hons.)</span>
                                    </div>
                                    <div class="single-course-summary">
                                        <h4>Course Credits</h4>
                                        <span><i class="fa fa-diamond"></i> 88/44</span>
                                    </div>
                                    <div class="single-course-summary">
                                        <h4>Total Semester</h4>
                                        <span><i class="fa fa-book"></i> 4/2</span>
                                    </div>
                                </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to excellence in postgraduate life sciences education through modern laboratories, advanced equipment, and highly qualified faculty. The university emphasizes practical training, research projects, industry exposure, and scientific innovation. Our mission is to develop skilled, research-driven, and industry-ready microbiology professionals who contribute to healthcare, diagnostics, biotechnology, public health, and global scientific advancements.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Focuses on advanced microbial genetics, industrial and medical microbiology, molecular techniques, and hands-on laboratory training for research and biotechnology careers.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Career opportunities include research labs, pharmaceutical and biotechnology industries, clinical diagnostics, environmental monitoring, and academic research/PhD pathways.</p>
                            </div>
                        </div>
                    </div>
