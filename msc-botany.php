<?php
$page_title = "M.Sc. Botany | Maya Devi University Dehradun";
$page_description = "The M.Sc. Botany program is designed to provide advanced knowledge and research skills in plant biology, biotechnology, ecology, physiology, taxonomy, and...";
$canonical_url = "https://maya.edu.in/msc-botany.php";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Botany</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.Sc. Botany</h5>
                                <p>The M.Sc. Botany program at Maya Devi University provides a comprehensive and specialized study of plant sciences. The curriculum covers plant anatomy, physiology, biochemistry, taxonomy, genetics, plant biotechnology, ecology, microbiology, molecular biology, ethnobotany, and environmental biology.</p>
                                <p>Students gain hands-on experience through laboratory experiments, herbarium techniques, field excursions, ecological surveys, plant tissue culture, and research projects. The program strengthens scientific reasoning, practical skills, and research aptitude, preparing students for careers in agriculture, biotechnology, forestry, environmental conservation, and academic research.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is dedicated to offering high-quality postgraduate education in life sciences through advanced laboratories, experienced faculty, and research-driven teaching. The university promotes innovation, field-based learning, and sustainable practices to help students build strong scientific and analytical foundations. Our mission is to develop research-ready, skilled, and environmentally responsible botanists who contribute to agriculture, biodiversity conservation, biotechnology, and global plant science research.</p>
                    </div>
