...
<div class="event-area-maya bg-img default-overlay pt-10 pb-10">
    <div class="section-inner">
   
            <div class="col-lg-12">
                 <div class="reveal" style="margin-bottom:48px;">
      <div class="section-label">Know More</div>
      <h2 class="section-maya">Our <em>Blogs</em></h2>
    </div>
...
?>
    <div class="single-blog-maya">
        ...
        <div class="blog-content-wrap" style="display:flex; flex-direction:column; height:100%;">
            ...
            <div class="blog-content-maya" style="flex-grow:1;">
                <h4 class="text-white">
                    <a href="blog/<?= $slug ?>"><?= $title ?></a>
                </h4>
                <p class="text-white"><?= $excerpt ?></p>

                <div class="blog-meta-maya">
                    <ul>
