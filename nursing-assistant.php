...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/na.webp);">
        <div class="container">
            <h2>Nursing Assistant</h2>
            <p>The Nursing Assistant certificate course is a short-term program aimed at training students in basic patient care. It is ideal for individuals seeking quick entry into the healthcare sector or looking to support nursing teams in hospitals and elder care facilities.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>GNM</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : Nursing Assistant</h5>
                            <p>This program prepares students for meaningful roles in the healthcare field as Nursing Assistants. Graduates can work in hospitals, clinics, long-term care facilities, and home healthcare settings, supporting nurses and other healthcare professionals in providing quality patient care.</p>
                            <p>The curriculum covers essential healthcare knowledge, including basic anatomy, physiology, and infection control, along with practical skills such as patient hygiene, vital signs monitoring, basic medical procedures, and assisting with daily living activities. Through hands-on training, clinical practicums, and real-world experience, students gain the confidence and competence to provide compassionate support to patients across a variety of healthcare environments.</p>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>10+2 with minimum of 40% marks in qualifying examination as well as in English individually from any recognized board.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>English should be a compulsory subject in qualifying examination.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        ...
                                        <span><i class="fa fa-user"></i> 45</span>
                                    </div>
                                    <div class="single-course-summary">
                                        <h4>Course Duration</h4>
                                        <span><i class="fa fa-clock-o"></i> 1.5yrs</span>
                                    </div>
                                    <div class="single-course-summary">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Nursing Assistant program equips students with essential knowledge and practical skills in basic patient care and healthcare support. Supported by modern labs, hands-on training, and experienced faculty, the program combines theoretical learning with practical experience in real healthcare settings. Graduates are prepared for careers in hospitals, clinics, long-term care facilities, and community health centers, contributing to quality patient care and supporting healthcare services effectively.</p> 
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Assist in daily patient care and hygiene with competence.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Monitor vital signs and report abnormalities effectively.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Support nursing staff in clinical procedures and patient care.</p>
                                        </div>
                                    </div>
                    ...
                    <div class="sidebar-title mb-40">
                            <h4>Career Prospects</h4>
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Nursing Assistant in hospitals and elder care homes - Provide direct patient care support.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Home Health Aide - Assist patients in their homes with daily activities.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Ward Assistant - Support nursing teams in hospital wards and departments.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Entry-level healthcare support roles - Start a career in healthcare sector.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                        ...
                                        <div class="course-list-content">
                                            <p>Healthcare facility support staff - Contribute to healthcare operations.</p>
                                        </div>
                                    </div>
                                </div>
