<?php
$page_title = "B.Sc. CBZ (Chemistry, Botany, Zoology) | Maya Devi University Dehradun";
$page_description = "Bachelor of Science (B.Sc.) in Chemistry, Botany and Zoology (B.Sc. in CBZ) is a regular degree program which deals with the field of science and is designed...";
$canonical_url = "https://maya.edu.in/bsc-cbz.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>B.Sc. CBZ (Chemistry, Botany, Zoology)</h2>
            <p>Bachelor of Science (B.Sc.) in Chemistry, Botany and Zoology (B.Sc. in CBZ) is a regular degree program which deals with the field of science and is designed to emphasize the fundamentals of the basic sciences. The duration of the course is three years which consists of six semesters under the New Education Policy 2020.</p>
        </div>
    </div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. CBZ</h5>
                                <p>Maya Devi University’s B.Sc. CBZ program focuses on providing students with extensive knowledge and practical exposure in Chemistry, Botany, and Zoology. The course blends theoretical learning with laboratory-based experiments, field studies, and research-oriented assignments to build a strong understanding of living organisms, plant and animal sciences, and chemical processes.</p>
                                <p>With modern laboratory facilities, expert faculty, and hands-on practical training, students develop scientific skills, ecological awareness, and analytical abilities. Graduates are well-prepared to pursue higher education or careers in research labs, environmental agencies, pharmaceutical industries, agricultural sectors, and life science organizations, contributing effectively to biological and environmental development.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to providing high-quality education, modern learning facilities, and a research-oriented environment to help students excel in their chosen fields. With highly qualified faculty, advanced laboratories, and innovative teaching methods, the university focuses on skill development, practical exposure, and career-centered learning. We aim to nurture responsible, knowledgeable, and confident graduates who can contribute meaningfully to society, industry, research, and global development.</p>
                    </div>
