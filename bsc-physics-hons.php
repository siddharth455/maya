...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>Bachelor of Science (B.Sc.) Hons. in Physics</h2>
            <p>The B.Sc. (Hons.) Physics program is designed to develop advanced conceptual, analytical, and research skills in physics, focusing on theoretical understanding, mathematical applications, and scientific experimentation. It prepares students for higher studies, research, and professional scientific careers in national and international domains.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Bachelor of Science (B.Sc.) Hons. in Physics</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Bachelor of Science (B.Sc.) Hons. in Physics</h5>
                                <p>The Bachelor of Science (B.Sc.) Hons. in Physics program at Maya Devi University offers an in-depth and specialized curriculum focused on classical physics, modern physics, computational physics, electronics, mathematical physics, and advanced experimental studies. The honors program provides extended research exposure, project work, seminars, and problem-based learning modules to strengthen scientific thinking and innovation.</p>
                                <p>By integrating theoretical concepts with laboratory experimentation, analytical modelling, and scientific computing, the program prepares students for future careers in research laboratories, higher education, technology-driven industries, and national/international scientific organizations.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to providing high-quality, research-focused, and concept-driven scientific education. With modern laboratories, well-qualified faculty, advanced teaching methodologies, and practical exposure, the university ensures that students gain both theoretical depth and real-world scientific competency. Our aim is to produce highly skilled, research-ready, and innovation-oriented graduates who can contribute to scientific and technological advancements globally.</p>
                    </div>
