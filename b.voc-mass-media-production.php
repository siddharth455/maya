<?php
$page_title = "B.Voc Mass Media Production in Dehradun | Maya Devi University";
$page_description = "Study B.Voc Mass Media Production at Maya Devi University, Dehradun with practical training in journalism, digital media, and content creation.";
$canonical_url = "https://maya.edu.in/b.voc-mass-media-production.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/media.webp);">
        <div class="container">
            <h2>B.Voc Mass Media & Production</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc Mass Media</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/media.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Mass Media & Production</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Mass Media & Production program equips students with creative, technical, and professional skills essential for success in the dynamic world of media and communication. The curriculum integrates theoretical understanding with hands-on training in journalism, film and video production, photography, audio-visual editing, and digital content creation. Students develop storytelling, communication, and technical expertise required to craft engaging media content across television, radio, film, and online platforms.</p> <p>Through studio-based learning, live projects, and internships with media houses, learners gain real-world experience in production, direction, scriptwriting, and post-production processes. The program emphasizes creativity, innovation, and ethical media practices, preparing graduates for careers as media producers, journalists, content creators, videographers, and editors in the film, broadcasting, advertising, and digital media industries.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Mass Media & Production program at Maya Devi University offers a skill-based and industry-focused curriculum designed to prepare students for dynamic careers in media, communication, and content creation. The program combines classroom learning with hands-on training in journalism, film and television production, photography, video editing, and digital media. Students develop strong creative, technical, and communication skills required to excel as media professionals, producers, content creators, and filmmakers in the ever-evolving media and entertainment industry.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Create and edit multimedia content.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understand media laws and storytelling.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Develop social media strategies.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Engage audiences through digital platforms.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Gain experience in studio production.</p>
                                </div>
                            </div>
                        </div>
                    </div>
