<?php
$page_title = "B.Voc Agriculture in Dehradun | Maya Devi University";
$page_description = "Enroll in B.Voc Agriculture at Maya Devi University, Dehradun with practical field training, modern labs, and industry-oriented curriculum.";
$canonical_url = "https://maya.edu.in/b.voc-agriculture.php";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc agri</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Agriculture</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Agriculture program focuses on providing students with industry-relevant skills and practical knowledge in various domains of modern agriculture. The curriculum blends theoretical foundations with hands-on training in crop production, soil management, horticulture, farm operations, and agribusiness practices. Students develop the technical expertise and entrepreneurial mindset required to meet the growing demands of the agricultural sector.</p> <p>Through extensive practical exposure in farms, laboratories, and field projects, learners gain real-world experience and competence in sustainable and scientific farming methods. The program emphasizes innovation, technology integration, and professional development through internships and industry collaborations. Graduates are prepared for diverse career opportunities as agricultural technicians, farm supervisors, agribusiness professionals, and entrepreneurs contributing to the advancement of sustainable agriculture.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Agriculture program at Maya Devi University offers a skill-oriented approach to modern agricultural education. The program combines classroom learning with practical training in crop production, soil health management, farm operations, and sustainable agricultural techniques. It prepares students for careers as agricultural technicians, farm supervisors, agripreneurs, and agribusiness professionals, equipping them with the technical and managerial skills needed to excel in the evolving agriculture sector.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Develop expertise in sustainable agriculture.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Apply modern tools and techniques in farming.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepare for roles in agri-business and research.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understand agricultural policies and rural development.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Gain proficiency in farm management and agri-finance.</p>
                                </div>
                            </div>
                        </div>
                    </div>
