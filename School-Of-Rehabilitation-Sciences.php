...
<section class="section-pad event-area-maya">
  <div class="container">
    <div class="reveal mb-4">
      ...
      <h2 class="section-maya text-white">Latest From <em>Ashtvakra School of Rehabilitation</em></h2>
    </div>
    <div class="row">
        ...
        <div class="dept-blog-card">
          <div class="dept-blog-img">
            <a href="rehabilitation-sciences-at-maya-devi-university.php">
              <img src="assets/uploads/rehabilitation-blog.png" alt="Restoring Lives, Rebuilding Abilities">
            </a>
          </div>
          <div class="dept-blog-body">
            ...
            <p class="dept-blog-excerpt">Study rehabilitation sciences, physiotherapy & allied rehab programs at the Ashtvakra School of Rehabilitation, Maya Devi University, Dehradun, Uttarakhand...</p>
            <div class="dept-blog-footer">
              <span class="dept-blog-date"><i class="fa fa-calendar-o"></i> Mar 25, 2026</span>
              <a href="rehabilitation-sciences-at-maya-devi-university.php" class="dept-blog-btn">Read Full Article &rarr;</a>
            </div>
          </div>
        </div>
      </div>
