<?php
$page_title = "BMRIT Course in Dehradun | Maya Devi University";
$page_description = "Enroll in BMRIT at Maya Devi University, Dehradun with advanced radiology labs and hands-on hospital exposure.";
$canonical_url = "https://maya.edu.in/bmrit.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/bmrit.webp);">
        <div class="container">
            <h2>Bachelor of Medical Radiology & Imaging Technology</h2>
            <p>The BMRIT program focuses on diagnostic imaging including Radiographic Techniques, CT & MRI Technology, Radiation Physics, and Patient Safety.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>BMRIT</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Bachelor of Medical Radiology & Imaging Technology (BMRIT)</h5>
                                ...
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>10+2 with Physics, Chemistry & Biology/Mathematics</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                ...
                                <div class="course-summary-wrap mt-4">
                                    ...
                                    <div class="single-course-summary">
                                        <h4>Approved Seats (2026–27): 30</h4>
