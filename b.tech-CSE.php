...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/b-tech-cs.jpeg);">
        <div class="container">
            <h2>B.Tech CSE</h2>
            <p>The Bachelor of Technology in Computer Science and Engineering (B.Tech CSE) is a comprehensive undergraduate program designed to provide students with both a strong theoretical foundation and practical skills necessary to thrive in the fast-evolving world of computing and technology. This program emphasizes the design, development, and implementation of software systems, computer networks, algorithms, and hardware technologies.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="#">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech CSE</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Tech CSE</h5>
                                <p>Students develop proficiency in a wide range of areas including programming languages, database management, software engineering, artificial intelligence, machine learning, cybersecurity, and cloud computing, among other advanced subjects. The curriculum integrates theoretical knowledge with hands- on projects and industry internships, ensuring graduates are well-prepared to meet current and future industry needs.</p>
                                <p>As technology continues to transform every sector—from healthcare and finance to entertainment and education—B.Tech CSE graduates are uniquely equipped to become innovators, critical thinkers, and leaders in the digital age. This degree opens diverse career opportunities in software development, data science, cybersecurity, research, and entrepreneurship, both within India and on the global stage.</p>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="single-course">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-data_science.php"><img class="animated" src="assets/img/course/related-course-2.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-cyber_security.php"><img class="animated" src="assets/img/course/related-course-3.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
