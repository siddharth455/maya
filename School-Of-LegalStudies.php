<?php require "common/header.php"?>
  ...
  <div class="hero-content">
      <h3 class="display-5 fw-bold text-white">School of Law & Legal Studies</h3>
      <p class="lead text-white">Shaping Tomorrow's Legal Leaders at Maya Devi University</p>
