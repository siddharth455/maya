<?php
$page_title = "M.Sc. Mathematics | Maya Devi University Dehradun";
$page_description = "The M.Sc. Mathematics program is designed to provide advanced knowledge in pure and applied mathematics, focusing on analytical reasoning, problem-solving...";
$canonical_url = "https://maya.edu.in/msc-mathematics.php";
...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            ...
            <p>The M.Sc. Mathematics program is designed to provide advanced knowledge in pure and applied mathematics, focusing on analytical reasoning, problem-solving, mathematical modeling, and research skills. It prepares graduates for careers in academics, data science, finance, research institutions, and higher studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Mathematics</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.Sc. Mathematics</h5>
                                <p>The M.Sc. Mathematics program at Maya Devi University offers in-depth study of advanced mathematical concepts and applications. The curriculum includes real & complex analysis, abstract algebra, topology, functional analysis, differential equations, numerical analysis, probability & statistics, optimization techniques, and mathematical modeling.</p>
                                <p>Students engage in rigorous problem-solving, research-based assignments, computational mathematics, and analytical projects. The program enhances logical reasoning, quantitative ability, and scientific thinking, preparing students for careers in data science, research organizations, financial institutions, teaching, and higher academic studies such as Ph.D. programs.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to providing high-quality postgraduate education in mathematics through expert faculty, modern teaching methodologies, and research-oriented learning. With a focus on analytical thinking, innovation, and advanced problem-solving, the university equips students with strong theoretical and practical mathematical skills. Our mission is to produce academically strong, research-ready, and professionally capable graduates who excel in science, technology, finance, and academia at national and global levels.</p>
                    </div>
