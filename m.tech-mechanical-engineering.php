<?php
$page_title = "M.Tech Mechanical Engineering in Dehradun | Maya Devi University";
$page_description = "Pursue M.Tech Mechanical Engineering at Maya Devi University, Dehradun with advanced research labs and industry-focused curriculum.";
$canonical_url = "https://maya.edu.in/m.tech-mechanical-engineering.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/mtech-mechanical.webp);">
        <div class="container">
            <h2>M.Tech in Mechanical Engineering</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.tech Mechanical</span></li>
            </ul>
        </div>
    </div>
</div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : M.tech Mechanical Engineering</h5>
                            <p> Our PG degrees from Maya Devi University are rooted in the real world of industry and the rapidly evolving needs of the engineering sector. Our students are equipped with knowledge and skills across a wide range of mechanical engineering topics. A PG degree in Mechanical Engineering is the basis for a career in a profession that offers an extremely wide choice of employment.</p>
                             <p>Our emphasis is on active learning, supported by state of the art practices in lectures and tutorials. The PG program provides a broad- ranging understanding of Mechanical Engineering principles and the confidence to apply this knowledge to real engineering problems.</p>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidate shall have Passed B. Tech Examination in Mechanical Engineering with at least 50% in case of general category and 40% in case of reserved category from recognized board.</p>
                                        </div>
                                    </div>
