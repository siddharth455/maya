<?php
$page_title = "M.Pharm Pharmaceutics in Dehradun | Maya Devi University";
$page_description = "Enroll in M.Pharm Pharmaceutics at Maya Devi University, Dehradun with modern pharmaceutical labs and research facilities.";
...
<div class="breadcrumb-area">
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Master in Pharmacy</span></li>
            </ul>
        </div>
    </div>
</div>
