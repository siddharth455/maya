<?php
$page_title = "B.Voc Welding Technology in Dehradun | Maya Devi University";
$page_description = "Study B.Voc Welding Technology at Maya Devi University, Dehradun with practical workshop training and modern industrial techniques.";
$canonical_url = "https://maya.edu.in/b.voc-welding.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/welding.webp);">
        <div class="container">
            <h2>B.Voc Welding</h2>
    ...
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Voc Welding</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/welding.webp" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Voc Welding</h5>
                                <p>The Bachelor of Vocation (B.Voc) in Welding program equips students with in-depth technical knowledge and hands-on expertise in modern welding technologies and fabrication processes. The curriculum integrates theory with practical training in techniques such as arc, MIG, TIG, and gas welding, along with material science, safety standards, and quality inspection. Students gain the technical, analytical, and problem-solving skills required in the manufacturing and construction industries.</p> <p>Through extensive practical sessions, industrial visits, and live projects, learners acquire real-world experience in welding operations, metal fabrication, and equipment maintenance. The program emphasizes precision, safety, and innovation, preparing graduates for careers as welding technicians, fabricators, quality inspectors, and supervisors in industrial production, oil and gas, and infrastructure sectors.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>The Bachelor of Vocation (B.Voc) in Welding program at Maya Devi University offers a skill-oriented and industry-focused curriculum designed to prepare students for technical careers in welding and fabrication. The program combines classroom learning with extensive hands-on training in modern welding methods, material science, and safety practices. Students develop the expertise and precision required to excel as welding technicians, fabricators, and supervisors in manufacturing, construction, and industrial sectors.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Master welding tools and safety procedures.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Perform different types of welding operations.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Understand welding codes and standards.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepare for industrial certifications.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Gain experience in fabrication and metalwork.</p>
                                </div>
                            </div>
                        </div>
                    </div>
