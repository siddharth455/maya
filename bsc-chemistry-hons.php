...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>B.Sc. Hons. in Chemistry</h2>
            <p>The B.Sc. (Hons.) Chemistry program is designed to provide advanced theoretical and practical knowledge of chemical sciences, including organic, inorganic, physical, and analytical chemistry. It emphasizes laboratory research, analytical techniques, and problem-solving skills, preparing graduates for careers in chemical industries, pharmaceuticals, research labs, and higher studies in India and abroad.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. Hons. in Chemistry</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. Hons. in Chemistry</h5>
                                <p>The B.Sc. (Hons.) Chemistry program at Maya Devi University offers an in-depth and specialized study of chemical sciences. The curriculum includes advanced topics in organic chemistry, inorganic chemistry, physical chemistry, analytical chemistry, spectroscopy, environmental chemistry, polymer chemistry, and biochemistry.</p>
                                <p>Students gain extensive hands-on experience through laboratory experiments, chemical synthesis, instrumental analysis, titrations, chromatography, spectroscopy techniques, and research-based projects. The honors structure includes deeper subject specialization, seminars, and an independent research project, enabling students to develop strong analytical, logical, and problem-solving abilities. Graduates are prepared for roles in research labs, pharmaceuticals, chemical industries, teaching, and higher academic programs.</p>
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>10+2 or equivalent with Physics and Mathematics alongwith Chemistry/ Comp.Sci. from a recognized board.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidates must have strong interest and aptitude in chemical sciences, laboratory techniques, and analytical reasoning.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University is committed to excellence in science education through modern laboratories, experienced faculty, and research-oriented learning. With state-of-the-art chemistry labs and hands-on practical training, the university focuses on developing strong scientific and analytical skills. Our aim is to prepare skilled, knowledgeable, and research-ready graduates who can contribute effectively to chemical industries, pharmaceutical companies, environmental laboratories, and scientific advancements worldwide.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>B.Sc. Chemistry is a four-year undergraduate program that focuses on Organic, Inorganic, and Physical Chemistry with both theoretical and practical laboratory training.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>After B.Sc. Chemistry, students can pursue higher studies (M.Sc./PhD) or work in fields like pharmaceuticals, chemical industries, research labs, quality control, and teaching.</p>
                            </div>
                        </div>
                    </div>
                </div>
