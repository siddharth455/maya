<?php
$page_title = "MA Fine Arts in Dehradun | Maya Devi University";
$page_description = "Enroll in MA Fine Arts at Maya Devi University, Dehradun with advanced social research training and academic excellence.";
$canonical_url = "https://maya.edu.in/ma-fine-arts.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/ma-9.jpeg);">
        <div class="container">
            <h2>M.A. in Fine Arts</h2>
            <p>The School of Arts and Humanities at Maya Devi University offers a two year full-time M.A. in Fine Arts, divided into four semesters.</p>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/ma-9.jpeg" alt="">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : M.A. in Fine Arts</h5>
                        <p>The course prepares students to become skilled artists, art educators, designers, researchers, and creative professionals in the field of visual and performing arts. Through studio practice, workshops, seminars, critiques, exhibitions, and research-based learning, learners develop artistic expression, technical proficiency, critical thinking, and a deep understanding of aesthetic principles and art history. Graduates can pursue careers in art studios, galleries, educational institutions, design firms, cultural organizations, media houses, and creative industries.</p> <p>The Master of Arts (M.A.) in Fine Arts program provides students with a strong foundation in painting, sculpture, applied arts, printmaking, visual communication, art history, and contemporary art practices. The curriculum integrates theoretical knowledge with intensive studio training and creative exploration, enabling students to develop their unique artistic voice while engaging with traditional and modern artistic techniques in diverse cultural contexts.</p>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                  ...
                  <p>The Master of Arts (M.A.) in Fine Arts program at Maya Devi University provides students with a strong foundation in painting, sculpture, applied arts, printmaking, visual communication, art history, and contemporary art practices. The curriculum integrates theoretical study with intensive studio training, creative exploration, and research-oriented learning, enabling students to express artistic ideas while engaging with traditional and modern art forms. Through seminars, studio sessions, supervised projects, workshops, exhibitions, internships, and interactive critiques, students gain practical exposure and develop creative, technical, and professional skills.</p>
                 </div>
