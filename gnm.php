<?php
$page_title = "GNM Nursing Course in Dehradun | Maya Devi University";
$page_description = "Enroll in GNM Nursing course at Maya Devi University, Dehradun with hospital-based clinical training.";
$canonical_url = "https://maya.edu.in/gnm.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/gnm.webp);">
        <div class="container">
            <h2>General Nursing and Midwifery (GNM)</h2>
            <p>The GNM diploma program focuses on preparing students for nursing and midwifery roles in both institutional and community settings. It blends theoretical instruction with hands-on experience in maternal care, pediatric nursing, and emergency response.</p>
        </div>
    </div>
                ...
                <div class="course-left-wrap mr-40">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : General Nursing and Midwifery (GNM)</h5>
                            <p>This specialization prepares students for rewarding careers in the healthcare sector. Graduates can work as Registered Nurses, Community Health Nurses, Midwives, or Clinical Instructors, and also pursue higher studies in nursing or specialized areas like pediatric, psychiatric, or critical care nursing.</p>
<p>The curriculum combines foundational medical sciences—such as anatomy, physiology, and microbiology—with professional nursing subjects like fundamentals of nursing, community health nursing, midwifery, child health nursing, and medical-surgical nursing. Through clinical postings, practical training, and real-world hospital experience, students develop the skills and confidence to provide compassionate and competent patient care in diverse healthcare settings.</p>
