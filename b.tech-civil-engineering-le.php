<?php
$page_title = "B.Tech Civil Engineering (Lateral Entry) in Dehradun | Maya Devi University";
$page_description = "Apply for B.Tech Civil Engineering Lateral Entry at Maya Devi University, Dehradun with industry-ready curriculum and placement support.";
$canonical_url = "https://maya.edu.in/b.tech-civil-engineering-le.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php"?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/civil-le.webp);">
        <div class="container">
            <h2>B.Tech in Civil Engineering<br>(Lateral Entry)</h2>
            <p>The importance of construction projects in the context of sustainable development has been steadily increasing, leading to a growing demand for civil engineering professionals.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.tech Civil (Lateral Entry)</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/civil-le.webp" alt="banner">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            ...
                            <h5>Course Name : B.tech Civil (Lateral Entry)</h5>
                            <p>The Civil Engineering Department boasts a team of expert faculty members and resources from prestigious institutions, committed to providing students with both a solid theoretical foundation and practical engineering experience. To further enhance practical skills, the department is equipped with state-of-the-art laboratories and research centers specializing in various subfields of Civil Engineering, including Structural Engineering, Earthquake Engineering, Transportation Engineering, Geotechnical Engineering, Fluid Mechanics, Environmental Engineering, and Concrete Technology.</p>
                             <p>In addition to academic excellence, the department focuses on preparing students for the professional world, helping them develop the career competencies necessary to succeed in the industry.The curriculum emphasizes structural analysis, design methodologies, and specialized subjects within Structural Engineering. Through projects, internships, site visits, seminars, workshops, and practical training, students gain in-depth technical expertise and develop strong analytical, design, and project management skills required to excel in professional, academic, and corporate engineering environments.</p>
                                ...
                                <h2>Eligibility Criteria</h2>
                                    <div class="sin-over-view-list">
                                        ...
                                        <div class="course-list-content">
                                            <p>Candidate shall have Passed Diploma in civil engineering. These subjects along with theory or theory + practical candidate should have obtained at least 45% .40% marks in the qualifying examination in case of SC/ST category.</p>
                                        </div>
                                    </div>
                                </div>
                                <h2>More Details</h2>
                    ...
                    <div class="related-course pt-70">
                        ...
                        <div class="single-course">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-civil-engineering.php"><img class="animated" src="assets/uploads/civil.webp" alt="Course Image"></a>
                                </div>
                                <div class="course-content">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="b.tech-mechatronics-and-robotics.php"><img class="animated" src="assets/uploads/robots.jpeg" alt="Course Image"></a>
                                </div>
                                <div class="course-content">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Tech Civil Engineering (Lateral Entry) program provides technical expertise and practical training in structural, transportation, and environmental engineering. Graduates are prepared for careers in engineering, project management, and research, contributing to infrastructure and sustainable development.</p>
                    </div>
