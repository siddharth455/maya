...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/bmlt.webp);">
        <div class="container">
            ...
            <p>The BMLT program is a professionally oriented undergraduate course that prepares students to become skilled laboratory technologists capable of supporting accurate diagnosis and effective treatment.</p>
        </div>
    </div>
