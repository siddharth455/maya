...
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/nursing-banner.webp);">
        <div class="container">
            <h2>B.Sc. PCM (Physics, Chemistry, Mathematics)</h2>
            <p>B.Sc. PCM is a undergraduate degree program focused on the fundamental concepts of science, specifically Physics, Chemistry, and Mathematics. This course provides a strong theoretical and practical foundation for students who are interested in science, research, technology, and analytical fields.</p>
        </div>
    </div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. PCM</h5>
                                <p>B.Sc. PCM (Physics, Chemistry, Mathematics) is a three-year undergraduate science programme designed for students who have a strong interest in analytical thinking, scientific learning, and problem-solving. The course provides an in-depth understanding of the core areas of Physics, Chemistry, and Mathematics, helping students build a solid theoretical and practical foundation to pursue careers in research, academics, technology, and applied sciences.</p>
                                <p>Throughout the programme, students study topics such as mechanics, electricity and magnetism, quantum physics, organic and inorganic chemistry, thermodynamics, calculus, algebra, statistics, and differential equations, which are essential for developing logical reasoning, experimentation skills, and quantitative analysis. The course encourages scientific curiosity and critical thinking through laboratory work, practical experiments, and project-based learning. After completing B.Sc. PCM, students can pursue higher studies like M.Sc., MCA, B.Ed., MBA, or specialized fields such as data science, actuarial science, and artificial intelligence, or they can opt for career opportunities in teaching, research organizations, IT companies, chemical industries, banking, and government sectors through competitive exams.</p>
                        ...
                        <div class="related-slider-active">
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="bsc-chemistry.php"><img class="animated" src="assets/uploads/bsc-pcm-img1.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="bsc-microbiology.php"><img class="animated" src="assets/uploads/bsc-pcm-img1.jpg" alt=""></a>
                                </div>
                                <div class="course-content">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Sc. PCM program provides students with a strong foundation in Physics, Chemistry, and Mathematics through a well-structured blend of theoretical concepts, laboratory experiments, and analytical problem-solving. Equipped with modern science labs, experienced faculty, and practical learning exposure, the course enables students to understand scientific principles, quantitative reasoning, and real-world applications. With a focus on research aptitude, logical thinking, and technical skills, graduates are prepared to pursue higher education or build careers in research institutions, education, data analytics, technology firms, government sectors, and other science-based industries, contributing effectively to scientific and technological advancements.</p>
                    </div>
