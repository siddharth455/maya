<?php
$page_title = "Master in Food Technology in Dehradun | Maya Devi University";
$page_description = "Enroll in Master in Food Technology at Maya Devi University, Dehradun with advanced food science research and lab training.";
$canonical_url = "https://maya.edu.in/master-in-food-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/food-2.webp);">
        <div class="container">
            <h2>Master of Science in Food Technology</h2>
            <p>The Master of Food Technology program equips students with in-depth knowledge and hands-on skills in food processing, preservation, quality assurance, and modern food production techniques.</p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>M.Sc. Food</span></li>
            </ul>
        </div>
    </div>
</div>
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : Master of Science in Food Technology</h5>
                                <p>The Master of Food Technology program provides in-depth knowledge and practical expertise in all aspects of food science and technology, including food processing, preservation, quality control, nutrition, and safety standards. Students gain both theoretical understanding and hands-on skills essential for careers in the food industry, research, and product development.</p> <p>Practical training in laboratories, pilot plants, and research projects enhances technical, analytical, and managerial competencies. The program emphasizes innovation, quality assurance, and modern food production techniques. Internships and industry collaborations prepare graduates for roles as food technologists, quality control analysts, product developers, and researchers in food processing, manufacturing, and safety sectors.</p>
                                <div class="over-view-list">
                                    ...
                                    <div class="sin-over-view-list">
                                        ...
                                        <p>B.Sc. in Microbiology, Food Technology, Biotechnology, Life Sciences, Home Sciences, Agriculture, Horticulture or a related field from a recognized university.</p>
                                        </div>
                                    </div>
                                    <div class="sin-over-view-list">
                                        <div class="course-list-icon">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s Master of Food Technology program provides comprehensive knowledge and practical training in food processing, preservation, quality control, and modern production techniques. Graduates are prepared for careers as food technologists, quality analysts, product developers, and researchers, contributing to innovation and efficiency in the food industry.</p>
                    </div>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Apply Advanced Food Science Knowledge: Utilize in-depth understanding of food chemistry, microbiology, and processing technologies to develop safe, nutritious and high-quality food products.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Ensure Food Safety and Quality: Implement industry-standard quality control, hygiene, and safety protocols in compliance with national and international food regulations.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Innovate in Product Development: Design and formulate new and improved food products using modern technologies, sustainable ingredients and market-driven insights.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Conduct Independent Research: Plan and carry out scientific research in areas such as food preservation, functional foods, packaging innovations and food biotechnology.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Address Global Food Security Challenges: Contribute to sustainable food systems by developing cost-effective and environmentally responsible solutions for large-scale food production.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Food Technologist / Product Developer</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Quality Assurance & Control Officer</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Research & Development Scientist</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Food Safety Officer / Inspector</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Academician / Lecturer / Research Fellow</p>
                            </div>
                        </div>
                    </div>
