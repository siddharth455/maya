<?php require "common/header.php"?>
  ...
  <div class="hero-content">
      <h3 class="display-5 fw-bold text-white">School of Paramedical Sciences</h3>
      <p class="lead text-white">Shaping Tomorrow's Healthcare Leaders at Maya Devi University</p>
