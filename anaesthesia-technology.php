<?php
$page_title = "Anaesthesia Technology Course in Dehradun | Maya Devi University";
$page_description = "Join Anaesthesia Technology program at Maya Devi University, Dehradun with hospital-based clinical training and expert faculty guidance.";
$canonical_url = "https://maya.edu.in/anaesthesia-technology.php";
$og_image = "https://maya.edu.in/assets/uploads/campus-2.jpeg";
?>
<?php require "common/header.php" ?>
<div class="breadcrumb-area">
    <div class="breadcrumb-top default-overlay bg-img breadcrumb-overly-2 pt-100 pb-95" style="background-image:url(assets/uploads/Anaesthesia.webp);">
        <div class="container">
            <h2>B.Sc. in Anaesthesia Technology</h2>
            <p>It focuses on equipping students with the knowledge and skills required to assist anesthesiologists during surgical procedures and in critical care settings. </p>
        </div>
    </div>
    <div class="breadcrumb-bottom">
        <div class="container">
            <ul>
                <li><a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>B.Sc. in Anaesthesia</span></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="col-xl-9 col-lg-8">
                <div class="course-left-wrap mr-40">
                    <div class="apply-area">
                        <img src="assets/uploads/Anaesthesia.webp" alt="banner">
                    ...
                    <div class="tab-content jump">
                        <div class="tab-pane active mt-5" id="course-details-1">
                            <div class="over-view-content">
                                ...
                                <h5>Course Name : B.Sc. in Anaesthesia Technology</h5>
                                <p>Core subjects include human anatomy, physiology, anaesthesia techniques, pharmacology, and patient monitoring. Students learn to assist anesthesiologists, prepare anaesthesia equipment, and ensure patient safety before, during, and after surgical procedures. The curriculum emphasizes practical training in anaesthesia administration and emergency management.</p>
                                <p>Hands-on labs and clinical internships enhance technical and clinical skills. The program focuses on precision, patient care, and adherence to medical standards. Research and training in hospital settings provide real-world experience. Graduates are prepared for roles as anaesthesia technologists, clinical assistants, and healthcare professionals in hospitals and surgical centers.</p>
                        ...
                        <div class="related-slider-active">
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="operation-theatre-technology.php"><img class="animated" src="assets/uploads/ott.webp" alt="Course Image"></a>
                                </div>
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="medical-lab-technology.php"><img class="animated" src="assets/uploads/mlt.webp" alt="Course Image"></a>
                                </div>
                                <div class="course-content">
                            ...
                            <div class="single-course">
                                <div class="course-img">
                                    <a href="cardiac-care-technology.php"><img class="animated" src="assets/uploads/cardiac.webp" alt="Course Image"></a>
                                </div>
                                <div class="course-content">
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="sidebar-style sidebar-res-mrg-none">
                    ...
                    <div class="sidebar-about mb-40">
                        ...
                        <p>Maya Devi University’s B.Sc. in Anaesthesia Technology program provides comprehensive knowledge and hands-on training in anaesthesia procedures, patient monitoring, and operation theatre management. Graduates are prepared for careers as anaesthesia technologists, clinical assistants, and healthcare professionals, ensuring safe and efficient anaesthetic care in hospitals and surgical centers.</p>
                    ...
                    <div class="sidebar-recent-course-wrap mb-40">
                        ...
                        <div class="over-view-list">
                            ...
                            <div class="sin-over-view-list">
                                ...
                                <div class="course-list-content">
                                    <p>Assist anesthesiologists in administering anesthesia and monitoring patients.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Operate and maintain anesthesia machines and related equipment.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Monitor vital signs and respond to intra-operative emergencies.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Prepare patients for anesthesia and support post-operative recovery.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Apply safety and sterilization protocols in clinical settings.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Maintain accurate anesthesia records and documentation.</p>
                                </div>
                            </div>
                            <div class="sin-over-view-list">
                                <div class="course-list-icon">
                                ...
                                <div class="course-list-content">
                                    <p>Demonstrate professionalism and empathy in patient care.</p>
                                </div>
                            </div>
                    ...
                    <div class="over-view-list">
                        ...
                        <div class="sin-over-view-list">
                            ...
                            <div class="course-list-content">
                                <p>Operation Theatre Assistant</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Emergency Response Technician</p>
                            </div>
                        </div>
                        <div class="sin-over-view-list">
                            <div class="course-list-icon">
                            ...
                            <div class="course-list-content">
                                <p>Pain Management Clinic Assistant</p>
                            </div>
                        </div>
