...
<div class="slider-area ">
    <div class="slider-active-2 owl-carousel nav-style-2">
        <div class="single-slider slider-height-3 bg-img pt-170" style="background-image:url(assets/img/slider/slider-bg.jpg);">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 col-sm-6">
                        <div class="slider-content-3 slider-animated-2 pt-115 ml-55">
                            ...
                            <div class="slider-btn">
                                <a class="animated default-btn btn-green-color" href="cart.php">ADD TO CART</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="producta-active">
            <div class="product-wrap">
                <div class="product-img">
                    <a href="single-product.php"><img src="assets/img/product/pro-1.jpg" alt=""></a>
                    <span>Sale</span>
                ...
                <div class="product-content">
                    <div class="pro-title-rating-wrap">
                        <div class="product-title">
                            <h3><a href="single-product.php">Marker Pen</a></h3>
                        </div>
            ...
            <div class="product-wrap">
                <div class="product-img">
                    <a href="single-product.php"><img src="assets/img/product/pro-2.jpg" alt=""></a>
                    <div class="product-action">
                        <ul>
                            <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                            <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                ...
                <div class="product-content">
                    <div class="pro-title-rating-wrap">
                        <div class="product-title">
                            <h3><a href="single-product.php">Color Pencil</a></h3>
                        </div>
                        <div class="product-rating">
                            <i class="zmdi zmdi-star"></i>
                            <i class="zmdi zmdi-star"></i>
            ...
            <div class="product-wrap">
                <div class="product-img">
                    <a href="single-product.php"><img src="assets/img/product/pro-3.jpg" alt=""></a>
                    <span>Sale</span>
                    <div class="product-action">
                        <ul>
                            <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                ...
                <div class="product-content">
                    <div class="pro-title-rating-wrap">
                        <div class="product-title">
                            <h3><a href="single-product.php">Color Box</a></h3>
                        </div>
                        <div class="product-rating">
                            <i class="zmdi zmdi-star"></i>
                            <i class="zmdi zmdi-star"></i>
            ...
            <div class="product-wrap">
                <div class="product-img">
                    <a href="single-product.php"><img src="assets/img/product/pro-4.jpg" alt=""></a>
                    <div class="product-action">
                        <ul>
                            <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                            <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                ...
                <div class="product-content">
                    <div class="pro-title-rating-wrap">
                        <div class="product-title">
                            <h3><a href="single-product.php">Toy mobile</a></h3>
                        </div>
                        <div class="product-rating">
                            <i class="zmdi zmdi-star"></i>
                            <i class="zmdi zmdi-star"></i>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-wrap mb-30">
                            <div class="product-img">
                                <a href="single-product.php"><img src="assets/img/product/pro-5.jpg" alt=""></a>
                                <div class="product-action">
                                    <ul>
                                        <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                        <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                            ...
                            <div class="product-content">
                                <div class="pro-title-rating-wrap">
                                    <div class="product-title">
                                        <h3><a href="single-product.php">Awesome vase</a></h3>
                                    </div>
                                    <div class="product-rating">
                                        <i class="zmdi zmdi-star"></i>
                                        <i class="zmdi zmdi-star"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-wrap mb-30">
                            <div class="product-img">
                                <a href="single-product.php"><img src="assets/img/product/pro-6.jpg" alt=""></a>
                                <span>Sale</span>
                                <div class="product-action">
                                    <ul>
                                        <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                            ...
                            <div class="product-content">
                                <div class="pro-title-rating-wrap">
                                    <div class="product-title">
                                        <h3><a href="single-product.php">Ceramic vase</a></h3>
                                    </div>
                                    <div class="product-rating">
                                        <i class="zmdi zmdi-star"></i>
                                        <i class="zmdi zmdi-star"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-wrap mb-30">
                            <div class="product-img">
                                <a href="single-product.php"><img src="assets/img/product/pro-7.jpg" alt=""></a>
                                <div class="product-action">
                                    <ul>
                                        <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                        <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                            ...
                            <div class="product-content">
                                <div class="pro-title-rating-wrap">
                                    <div class="product-title">
                                        <h3><a href="single-product.php">Smart Watch</a></h3>
                                    </div>
                                    <div class="product-rating">
                                        <i class="zmdi zmdi-star"></i>
                                        <i class="zmdi zmdi-star"></i>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="product-wrap mb-30">
                            <div class="product-img">
                                <a href="single-product.php"><img src="assets/img/product/pro-8.jpg" alt=""></a>
                                <div class="product-action">
                                    <ul>
                                        <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                        <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                            ...
                            <div class="product-content">
                                <div class="pro-title-rating-wrap">
                                    <div class="product-title">
                                        <h3><a href="single-product.php">History Book</a></h3>
                                    </div>
                                    <div class="product-rating">
                                        <i class="zmdi zmdi-star"></i>
                                        <i class="zmdi zmdi-star"></i>
...
<div class="discount-area bg-img pt-110 pb-90" style="background-image:url(assets/img/bg/bg-7.jpg);">
    <div class="container">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product-wrap mb-30">
                    <div class="product-img">
                        <a href="single-product.php"><img src="assets/img/product/pro-9.jpg" alt=""></a>
                        <div class="product-action">
                            <ul>
                                <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product-wrap mb-30">
                    <div class="product-img">
                        <a href="single-product.php"><img src="assets/img/product/pro-10.jpg" alt=""></a>
                        <span>Sale</span>
                        <div class="product-action">
                            <ul>
                                <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                    ...
                    <div class="product-content">
                        <div class="pro-title-rating-wrap">
                            <div class="product-title">
                                <h3><a href="single-product.php">Softball Gloves</a></h3>
                            </div>
                            <div class="product-rating">
                                <i class="zmdi zmdi-star"></i>
                                <i class="zmdi zmdi-star"></i>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="product-wrap mb-30">
                    <div class="product-img">
                        <a href="single-product.php"><img src="assets/img/product/pro-11.jpg" alt=""></a>
                        <div class="product-action">
                            <ul>
                                <li><a title="Add To Cart" href="#"><i class="fa fa-cart-arrow-down"></i></a></li>
                                <li><a title="Compare" href="#"><i class="fa fa-random"></i></a></li>
                    ...
                    <div class="product-content">
                        <div class="pro-title-rating-wrap">
                            <div class="product-title">
                                <h3><a href="single-product.php">Skating Shoes</a></h3>
                            </div>
                            <div class="product-rating">
                                <i class="zmdi zmdi-star"></i>
                                <i class="zmdi zmdi-star"></i>
